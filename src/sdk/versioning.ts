...
import { versioningCleanWorkingDir } from "../funcs/versioningCleanWorkingDir.js";
...
import { versioningShowCommit } from "../funcs/versioningShowCommit.js";
...
export class Versioning extends ClientSDK {
  ...
  async showCommit(
    ...
    return unwrapAsync(versioningShowCommit(
      this,
      request,
      options,
    ));
  ...
  async cleanWorkingDir(
    ...
    return unwrapAsync(versioningCleanWorkingDir(
      this,
      request,
      options,
    ));
