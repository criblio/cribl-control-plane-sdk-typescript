...
import type { ClientRequestScope } from "../lib/config.js";
...
export class CriblControlPlane extends ClientSDK {
  /** Client with requests rooted at `/api/v1/m/{group}/` or `/api/v1/w/{node}/`. */
  scoped(scope: ClientRequestScope): CriblControlPlane {
    return new CriblControlPlane({
      ...this._options,
      requestScope: scope,
    });
  }
