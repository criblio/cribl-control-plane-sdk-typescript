...
import { versionsCommitsCountFiles } from "../funcs/versionsCommitsCountFiles.js";
...
import { versionsCommitsListFiles } from "../funcs/versionsCommitsListFiles.js";
...
export class Commits extends ClientSDK {
  ...
  async countFiles(
    ...
    return unwrapAsync(versionsCommitsCountFiles(
      this,
      request,
      options,
    ));
  ...
  async listFiles(
    ...
    return unwrapAsync(versionsCommitsListFiles(
      this,
      request,
      options,
    ));
