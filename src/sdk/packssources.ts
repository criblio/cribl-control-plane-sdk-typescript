...
export class PacksSources extends ClientSDK {
  ...
  private _statuses?: PacksSourcesStatuses;
  get statuses(): PacksSourcesStatuses {
    return (this._statuses ??= new PacksSourcesStatuses(this._options));
  }
