...
export const SDK_METADATA = {
  language: "typescript",
  openapiDocVersion: "4.18.2-alpha.1780700647849-20fcce49",
  sdkVersion: "0.9.0-alpha.11",
  genVersion: "2.893.0",
  userAgent:
    "speakeasy-sdk/typescript 0.9.0-alpha.11 2.893.0 4.18.2-alpha.1780700647849-20fcce49 cribl-control-plane",
} as const;
