...
export const SDK_METADATA = {
  language: "typescript",
  openapiDocVersion: "4.18.0-alpha.1776929218545-ca4fcc96",
  sdkVersion: "0.8.0-rc.1",
  genVersion: "2.881.2",
  userAgent:
    "speakeasy-sdk/typescript 0.8.0-rc.1 2.881.2 4.18.0-alpha.1776929218545-ca4fcc96 cribl-control-plane",
} as const;
