...
export const SDK_METADATA = {
  language: "typescript",
  openapiDocVersion: "4.18.0-alpha.1775586370720-c6a723dc",
  sdkVersion: "0.7.0-rc.12",
  genVersion: "2.879.6",
  userAgent:
    "speakeasy-sdk/typescript 0.7.0-rc.12 2.879.6 4.18.0-alpha.1775586370720-c6a723dc cribl-control-plane",
} as const;
