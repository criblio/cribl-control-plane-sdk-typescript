...
export const SDK_METADATA = {
  language: "typescript",
  openapiDocVersion: "4.18.2-alpha.1779798728548-c6642a58",
  sdkVersion: "0.9.0-rc.1",
  genVersion: "2.886.1",
  userAgent:
    "speakeasy-sdk/typescript 0.9.0-rc.1 2.886.1 4.18.2-alpha.1779798728548-c6642a58 cribl-control-plane",
} as const;
