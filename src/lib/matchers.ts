...
import { CriblControlPlaneDefaultError } from "../models/errors/criblcontrolplanedefaulterror.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | CriblControlPlaneDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<
        T,
        E | CriblControlPlaneDefaultError | ResponseValidationError
      >,
      raw: unknown,
    ]
  > {
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new CriblControlPlaneDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new CriblControlPlaneDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
