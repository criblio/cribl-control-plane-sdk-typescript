...
/** @internal */
export type FunctionRedis$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionRedis$outboundSchema: z.ZodType<
...
export function functionRedisToJSON(functionRedis: FunctionRedis): string {
  return JSON.stringify(FunctionRedis$outboundSchema.parse(functionRedis));
}
