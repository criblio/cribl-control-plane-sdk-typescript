...
/** @internal */
export type FunctionGenStats$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionGenStats$outboundSchema: z.ZodType<
...
export function functionGenStatsToJSON(
  functionGenStats: FunctionGenStats,
): string {
  return JSON.stringify(
    FunctionGenStats$outboundSchema.parse(functionGenStats),
  );
}
