...
export const PipelineFunctionWindowConf$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  eventWindowId: types.number(),
  registeredFunctions: z.array(types.string()),
  tailEventCount: types.optional(types.number()),
  headEventCount: types.optional(types.number()),
});
/** @internal */
