...
/** @internal */
export type InputHttpInput$Outbound = {
  id?: string | undefined;
  type: "http";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputHttpInput$outboundSchema: z.ZodType<
...
export function inputHttpInputToJSON(inputHttpInput: InputHttpInput): string {
  return JSON.stringify(InputHttpInput$outboundSchema.parse(inputHttpInput));
}
