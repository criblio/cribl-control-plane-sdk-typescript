...
/** @internal */
export type FunctionSampling$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionSampling$outboundSchema: z.ZodType<
...
export function functionSamplingToJSON(
  functionSampling: FunctionSampling,
): string {
  return JSON.stringify(
    FunctionSampling$outboundSchema.parse(functionSampling),
  );
}
