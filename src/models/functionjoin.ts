...
/** @internal */
export type FunctionJoin$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionJoin$outboundSchema: z.ZodType<
...
export function functionJoinToJSON(functionJoin: FunctionJoin): string {
  return JSON.stringify(FunctionJoin$outboundSchema.parse(functionJoin));
}
