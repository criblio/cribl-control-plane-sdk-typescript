 ...
 */
export const InputMicrosoftGraphSubscriptionPlan = {
  /**
 ...
 * Microsoft 365 subscription plan for your organization, typically Microsoft 365 Enterprise
 */
export type InputMicrosoftGraphSubscriptionPlan = OpenEnum<
  typeof InputMicrosoftGraphSubscriptionPlan
>;

export type InputMicrosoftGraphInput = {
  /**
   ...
   * Microsoft 365 subscription plan for your organization, typically Microsoft 365 Enterprise
   */
  planType?: InputMicrosoftGraphSubscriptionPlan | undefined;
  /**
...
/** @internal */
export const InputMicrosoftGraphSubscriptionPlan$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  InputMicrosoftGraphSubscriptionPlan
> = openEnums.outboundSchema(InputMicrosoftGraphSubscriptionPlan);

/** @internal */
export type InputMicrosoftGraphInput$Outbound = {
  id?: string | undefined;
  type: "microsoft_graph";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputMicrosoftGraphInput$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  planType: InputMicrosoftGraphSubscriptionPlan$outboundSchema.optional(),
...
export function inputMicrosoftGraphInputToJSON(
  inputMicrosoftGraphInput: InputMicrosoftGraphInput,
): string {
  return JSON.stringify(
    InputMicrosoftGraphInput$outboundSchema.parse(inputMicrosoftGraphInput),
  );
}
