...
/** @internal */
export const InputUnion1$inboundSchema: z.ZodType<
  InputUnion1,
  z.ZodTypeDef,
  unknown
...
export function inputUnion1FromJSON(
  jsonString: string,
): SafeParseResult<InputUnion1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InputUnion1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InputUnion1' from JSON`,
  );
}
