...
/** @internal */
export type FunctionExternaldata$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionExternaldata$outboundSchema: z.ZodType<
...
export function functionExternaldataToJSON(
  functionExternaldata: FunctionExternaldata,
): string {
  return JSON.stringify(
    FunctionExternaldata$outboundSchema.parse(functionExternaldata),
  );
}
