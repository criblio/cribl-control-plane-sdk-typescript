...
export type InputSecurityLakeInput = {
  /**
...
/** @internal */
export type InputSecurityLakeInput$Outbound = {
  id?: string | undefined;
  type: "security_lake";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputSecurityLakeInput$outboundSchema: z.ZodType<
...
export function inputSecurityLakeInputToJSON(
  inputSecurityLakeInput: InputSecurityLakeInput,
): string {
  return JSON.stringify(
    InputSecurityLakeInput$outboundSchema.parse(inputSecurityLakeInput),
  );
}
