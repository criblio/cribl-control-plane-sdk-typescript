 ...
 */
export const InputPrometheusMetricsProtocol = {
  Http: "http",
  Https: "https",
} as const;
/**
 * Protocol to use when collecting metrics
 */
export type InputPrometheusMetricsProtocol = OpenEnum<
  typeof InputPrometheusMetricsProtocol
>;
...
export type InputPrometheusInput = {
   ...
   * Protocol to use when collecting metrics
   */
  scrapeProtocol?: InputPrometheusMetricsProtocol | undefined;
  /**
...
/** @internal */
export const InputPrometheusMetricsProtocol$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  InputPrometheusMetricsProtocol
> = openEnums.outboundSchema(InputPrometheusMetricsProtocol);
...
> = z.object({
  ...
  scrapeProtocol: InputPrometheusMetricsProtocol$outboundSchema.optional(),
