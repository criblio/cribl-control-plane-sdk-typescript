...
/** @internal */
export type InputTcpjsonInput$Outbound = {
  id?: string | undefined;
  type: "tcpjson";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputTcpjsonInput$outboundSchema: z.ZodType<
...
export function inputTcpjsonInputToJSON(
  inputTcpjsonInput: InputTcpjsonInput,
): string {
  return JSON.stringify(
    InputTcpjsonInput$outboundSchema.parse(inputTcpjsonInput),
  );
}
