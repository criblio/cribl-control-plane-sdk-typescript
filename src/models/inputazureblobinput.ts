...
export type InputAzureBlobInput = {
  /**
...
/** @internal */
export type InputAzureBlobInput$Outbound = {
  id?: string | undefined;
  type: "azure_blob";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputAzureBlobInput$outboundSchema: z.ZodType<
...
export function inputAzureBlobInputToJSON(
  inputAzureBlobInput: InputAzureBlobInput,
): string {
  return JSON.stringify(
    InputAzureBlobInput$outboundSchema.parse(inputAzureBlobInput),
  );
}
