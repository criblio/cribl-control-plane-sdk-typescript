 ...
 * Endpoint name
 */
export const CreateInputEndpointName = {
 ...
 * Endpoint name
 */
export type CreateInputEndpointName = OpenEnum<typeof CreateInputEndpointName>;
...
export type CreateInputContentConfigAnthropicCompliance = {
   ...
   * Endpoint name
   */
  contentType: CreateInputEndpointName;
  /**
   * Description
   */
...
/** @internal */
export const CreateInputEndpointName$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  CreateInputEndpointName
> = openEnums.outboundSchema(CreateInputEndpointName);
...
export const CreateInputContentConfigAnthropicCompliance$outboundSchema:
  ...
  > = z.object({
    contentType: CreateInputEndpointName$outboundSchema,
