...
> = z.union([
  ...
  z.lazy(() => CreateOutputSystemByPackOutputGooglePubsub$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputExabeam$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputKafka$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputConfluentCloud$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputMsk$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputElastic$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputElasticCloud$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputNewrelic$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputNewrelicEvents$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputInfluxdb$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCloudwatch$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputMinio$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputStatsd$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputStatsdExt$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputGraphite$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputRouter$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSns$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSqs$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSnmp$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSumoLogic$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDatadog$outboundSchema),
  smartUnion([
    z.lazy(() =>
      CreateOutputSystemByPackOutputGrafanaCloudGrafanaCloud1$outboundSchema
    ),
  ...
  z.lazy(() => CreateOutputSystemByPackOutputLoki$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputPrometheus$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputRing$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputOpenTelemetry$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputServiceNow$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDataset$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCriblTcp$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCriblHttp$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCriblSearchEngine$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputHumioHec$outboundSchema),
  z.lazy(() =>
    CreateOutputSystemByPackOutputCrowdstrikeNextGenSiem$outboundSchema
  ),
  z.lazy(() => CreateOutputSystemByPackOutputDlS3$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSecurityLake$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCriblLake$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDiskSpool$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputClickHouse$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputXsiam$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputNetflow$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDynatraceHttp$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDynatraceOtlp$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputSentinelOneAiSiem$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputChronicle$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputDatabricks$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputMicrosoftFabric$outboundSchema),
  z.lazy(() => CreateOutputSystemByPackOutputCloudflareR2$outboundSchema),
]);
