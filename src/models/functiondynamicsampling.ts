...
/** @internal */
export type FunctionDynamicSampling$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionDynamicSampling$outboundSchema: z.ZodType<
...
export function functionDynamicSamplingToJSON(
  functionDynamicSampling: FunctionDynamicSampling,
): string {
  return JSON.stringify(
    FunctionDynamicSampling$outboundSchema.parse(functionDynamicSampling),
  );
}
