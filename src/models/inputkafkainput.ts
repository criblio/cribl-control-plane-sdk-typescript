...
/** @internal */
export type InputKafkaInput$Outbound = {
  id?: string | undefined;
  type: "kafka";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputKafkaInput$outboundSchema: z.ZodType<
...
export function inputKafkaInputToJSON(
  inputKafkaInput: InputKafkaInput,
): string {
  return JSON.stringify(InputKafkaInput$outboundSchema.parse(inputKafkaInput));
}
