...
/** @internal */
export type FunctionDnsLookup$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionDnsLookup$outboundSchema: z.ZodType<
...
export function functionDnsLookupToJSON(
  functionDnsLookup: FunctionDnsLookup,
): string {
  return JSON.stringify(
    FunctionDnsLookup$outboundSchema.parse(functionDnsLookup),
  );
}
