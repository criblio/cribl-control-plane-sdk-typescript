...
export type InputCriblHttpInput = {
  /**
...
/** @internal */
export type InputCriblHttpInput$Outbound = {
  id?: string | undefined;
  type: "cribl_http";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputCriblHttpInput$outboundSchema: z.ZodType<
...
export function inputCriblHttpInputToJSON(
  inputCriblHttpInput: InputCriblHttpInput,
): string {
  return JSON.stringify(
    InputCriblHttpInput$outboundSchema.parse(inputCriblHttpInput),
  );
}
