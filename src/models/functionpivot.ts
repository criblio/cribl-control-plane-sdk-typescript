...
/** @internal */
export type FunctionPivot$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionPivot$outboundSchema: z.ZodType<
...
export function functionPivotToJSON(functionPivot: FunctionPivot): string {
  return JSON.stringify(FunctionPivot$outboundSchema.parse(functionPivot));
}
