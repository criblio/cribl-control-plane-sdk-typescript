...
export type FunctionSearchEngineExport = {
  /**
...
/** @internal */
export const FunctionSearchEngineExport$inboundSchema: z.ZodType<
...
export function functionSearchEngineExportFromJSON(
  jsonString: string,
): SafeParseResult<FunctionSearchEngineExport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FunctionSearchEngineExport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FunctionSearchEngineExport' from JSON`,
  );
}
