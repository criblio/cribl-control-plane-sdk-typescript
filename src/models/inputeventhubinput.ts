...
export type InputEventhubInput = {
  /**
...
/** @internal */
export type InputEventhubInput$Outbound = {
  id?: string | undefined;
  type: "eventhub";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputEventhubInput$outboundSchema: z.ZodType<
...
export function inputEventhubInputToJSON(
  inputEventhubInput: InputEventhubInput,
): string {
  return JSON.stringify(
    InputEventhubInput$outboundSchema.parse(inputEventhubInput),
  );
}
