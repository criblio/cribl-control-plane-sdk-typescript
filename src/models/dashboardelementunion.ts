...
import {
  DashboardLayout,
  DashboardLayout$inboundSchema,
  DashboardLayout$Outbound,
  DashboardLayout$outboundSchema,
...
> = z.object({
  ...
  layout: DashboardLayout$inboundSchema,
...
export type DashboardElement3$Outbound = {
  ...
  id: string;
  index?: number | undefined;
  layout: DashboardLayout$Outbound;
  title?: string | undefined;
...
> = z.object({
  ...
  id: z.string(),
  index: z.number().optional(),
  layout: DashboardLayout$outboundSchema,
  title: z.string().optional(),
...
> = z.object({
  ...
  variant: Variant2$inboundSchema.optional(),
});
...
> = z.object({
  ...
  value: z.record(z.any()).optional(),
  variant: Variant2$outboundSchema.optional(),
});
