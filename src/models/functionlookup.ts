...
/** @internal */
export type FunctionLookup$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionLookup$outboundSchema: z.ZodType<
...
export function functionLookupToJSON(functionLookup: FunctionLookup): string {
  return JSON.stringify(FunctionLookup$outboundSchema.parse(functionLookup));
}
