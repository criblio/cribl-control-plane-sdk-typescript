...
export type InputAppscopeAllow = {
  /**
...
export type InputAppscopeFilter = {
   ...
   */
  allow?: Array<InputAppscopeAllow> | undefined;
  /**
 ...
 */
export type InputAppscopeUNIXSocketPermissions = string | number;
...
/** @internal */
export type InputAppscopeAllow$Outbound = {
  procname: string;
  arg?: string | undefined;
  config: string;
};
...
/** @internal */
export const InputAppscopeAllow$outboundSchema: z.ZodType<
  InputAppscopeAllow$Outbound,
  z.ZodTypeDef,
  InputAppscopeAllow
> = z.object({
  procname: z.string(),
...
export function inputAppscopeAllowToJSON(
  inputAppscopeAllow: InputAppscopeAllow,
): string {
  return JSON.stringify(
    InputAppscopeAllow$outboundSchema.parse(inputAppscopeAllow),
  );
}

/** @internal */
export type InputAppscopeFilter$Outbound = {
  allow?: Array<InputAppscopeAllow$Outbound> | undefined;
  transportURL?: string | undefined;
};
...
export const InputAppscopeFilter$outboundSchema: z.ZodType<
  ...
  InputAppscopeFilter
> = z.object({
  allow: z.array(z.lazy(() => InputAppscopeAllow$outboundSchema)).optional(),
...
/** @internal */
export type InputAppscopeUNIXSocketPermissions$Outbound = string | number;

/** @internal */
export const InputAppscopeUNIXSocketPermissions$outboundSchema: z.ZodType<
  InputAppscopeUNIXSocketPermissions$Outbound,
  z.ZodTypeDef,
  InputAppscopeUNIXSocketPermissions
> = smartUnion([z.string(), z.number()]);

export function inputAppscopeUNIXSocketPermissionsToJSON(
  inputAppscopeUNIXSocketPermissions: InputAppscopeUNIXSocketPermissions,
): string {
  return JSON.stringify(
    InputAppscopeUNIXSocketPermissions$outboundSchema.parse(
      inputAppscopeUNIXSocketPermissions,
    ),
  );
}
