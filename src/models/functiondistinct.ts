...
/** @internal */
export type FunctionDistinct$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionDistinct$outboundSchema: z.ZodType<
...
export function functionDistinctToJSON(
  functionDistinct: FunctionDistinct,
): string {
  return JSON.stringify(
    FunctionDistinct$outboundSchema.parse(functionDistinct),
  );
}
