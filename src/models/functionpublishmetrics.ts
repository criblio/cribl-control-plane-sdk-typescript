...
/** @internal */
export type FunctionPublishMetrics$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionPublishMetrics$outboundSchema: z.ZodType<
...
export function functionPublishMetricsToJSON(
  functionPublishMetrics: FunctionPublishMetrics,
): string {
  return JSON.stringify(
    FunctionPublishMetrics$outboundSchema.parse(functionPublishMetrics),
  );
}
