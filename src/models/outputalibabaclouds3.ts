...
/** @internal */
export const OutputAlibabaCloudS3$outboundSchema: z.ZodType<
...
export function outputAlibabaCloudS3ToJSON(
  outputAlibabaCloudS3: OutputAlibabaCloudS3,
): string {
  return JSON.stringify(
    OutputAlibabaCloudS3$outboundSchema.parse(outputAlibabaCloudS3),
  );
}
