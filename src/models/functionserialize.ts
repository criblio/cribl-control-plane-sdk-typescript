...
/** @internal */
export type FunctionSerialize$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionSerialize$outboundSchema: z.ZodType<
...
export function functionSerializeToJSON(
  functionSerialize: FunctionSerialize,
): string {
  return JSON.stringify(
    FunctionSerialize$outboundSchema.parse(functionSerialize),
  );
}
