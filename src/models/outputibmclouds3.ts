...
/** @internal */
export type OutputIbmCloudS3$Outbound = {
  id?: string | undefined;
  type: "ibm_cloud_s3";
  pipeline?: string | undefined;
  systemFields?: Array<string> | undefined;
...
/** @internal */
export const OutputIbmCloudS3$outboundSchema: z.ZodType<
...
export function outputIbmCloudS3ToJSON(
  outputIbmCloudS3: OutputIbmCloudS3,
): string {
  return JSON.stringify(
    OutputIbmCloudS3$outboundSchema.parse(outputIbmCloudS3),
  );
}
