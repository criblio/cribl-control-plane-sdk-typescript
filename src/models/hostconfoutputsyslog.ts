...
export type HostConfOutputSyslog = {
  /**
...
/** @internal */
export const HostConfOutputSyslog$inboundSchema: z.ZodType<
...
/** @internal */
export type HostConfOutputSyslog$Outbound = {
  host: string;
  port: number;
...
/** @internal */
export const HostConfOutputSyslog$outboundSchema: z.ZodType<
...
export function hostConfOutputSyslogToJSON(
  hostConfOutputSyslog: HostConfOutputSyslog,
): string {
  return JSON.stringify(
    HostConfOutputSyslog$outboundSchema.parse(hostConfOutputSyslog),
  );
}
export function hostConfOutputSyslogFromJSON(
  jsonString: string,
): SafeParseResult<HostConfOutputSyslog, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HostConfOutputSyslog$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HostConfOutputSyslog' from JSON`,
  );
}
