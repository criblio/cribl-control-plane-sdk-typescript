...
/** @internal */
export type FunctionOtlpLogs$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionOtlpLogs$outboundSchema: z.ZodType<
...
export function functionOtlpLogsToJSON(
  functionOtlpLogs: FunctionOtlpLogs,
): string {
  return JSON.stringify(
    FunctionOtlpLogs$outboundSchema.parse(functionOtlpLogs),
  );
}
