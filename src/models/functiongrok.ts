...
/** @internal */
export type FunctionGrok$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionGrok$outboundSchema: z.ZodType<
...
export function functionGrokToJSON(functionGrok: FunctionGrok): string {
  return JSON.stringify(FunctionGrok$outboundSchema.parse(functionGrok));
}
