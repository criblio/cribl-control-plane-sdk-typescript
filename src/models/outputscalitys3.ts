 ...
 */
export const OutputScalityS3SignatureVersion = {
  V2: "v2",
  V4: "v4",
} as const;
/**
 * Signature version to use for signing Scality requests
 */
export type OutputScalityS3SignatureVersion = OpenEnum<
  typeof OutputScalityS3SignatureVersion
>;

export type OutputScalityS3 = {
  /**
   ...
   * Signature version to use for signing Scality requests
   */
  signatureVersion?: OutputScalityS3SignatureVersion | undefined;
  /**
...
/** @internal */
export const OutputScalityS3SignatureVersion$inboundSchema: z.ZodType<
  OutputScalityS3SignatureVersion,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(OutputScalityS3SignatureVersion);
/** @internal */
export const OutputScalityS3SignatureVersion$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  OutputScalityS3SignatureVersion
> = openEnums.outboundSchema(OutputScalityS3SignatureVersion);

/** @internal */
export const OutputScalityS3$inboundSchema: z.ZodType<
  OutputScalityS3,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  signatureVersion: types.optional(
    OutputScalityS3SignatureVersion$inboundSchema,
  ),
...
/** @internal */
export type OutputScalityS3$Outbound = {
  id?: string | undefined;
  type: "scality_s3";
  pipeline?: string | undefined;
  systemFields?: Array<string> | undefined;
...
/** @internal */
export const OutputScalityS3$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  awsAuthenticationMethod: AuthenticationMethodOptionse9c778$outboundSchema
    .optional(),
  signatureVersion: OutputScalityS3SignatureVersion$outboundSchema.optional(),
...
export function outputScalityS3ToJSON(
  outputScalityS3: OutputScalityS3,
): string {
  return JSON.stringify(OutputScalityS3$outboundSchema.parse(outputScalityS3));
}
export function outputScalityS3FromJSON(
  jsonString: string,
): SafeParseResult<OutputScalityS3, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OutputScalityS3$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OutputScalityS3' from JSON`,
  );
}
