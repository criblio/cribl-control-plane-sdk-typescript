...
export type InputBedrockS3Input = {
  /**
...
/** @internal */
export type InputBedrockS3Input$Outbound = {
  id?: string | undefined;
  type: "bedrock_s3";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputBedrockS3Input$outboundSchema: z.ZodType<
...
export function inputBedrockS3InputToJSON(
  inputBedrockS3Input: InputBedrockS3Input,
): string {
  return JSON.stringify(
    InputBedrockS3Input$outboundSchema.parse(inputBedrockS3Input),
  );
}
