...
/** @internal */
export type InputDatagenSample$Outbound = {
  sample: string;
  eventsPerSec: number;
};

/** @internal */
export const InputDatagenSample$outboundSchema: z.ZodType<
  InputDatagenSample$Outbound,
  z.ZodTypeDef,
  InputDatagenSample
> = z.object({
  sample: z.string(),
...
export function inputDatagenSampleToJSON(
  inputDatagenSample: InputDatagenSample,
): string {
  return JSON.stringify(
    InputDatagenSample$outboundSchema.parse(inputDatagenSample),
  );
}
