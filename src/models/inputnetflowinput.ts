...
/** @internal */
export type InputNetflowInput$Outbound = {
  id?: string | undefined;
  type: "netflow";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputNetflowInput$outboundSchema: z.ZodType<
...
export function inputNetflowInputToJSON(
  inputNetflowInput: InputNetflowInput,
): string {
  return JSON.stringify(
    InputNetflowInput$outboundSchema.parse(inputNetflowInput),
  );
}
