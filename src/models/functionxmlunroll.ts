...
/** @internal */
export type FunctionXmlUnroll$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionXmlUnroll$outboundSchema: z.ZodType<
...
export function functionXmlUnrollToJSON(
  functionXmlUnroll: FunctionXmlUnroll,
): string {
  return JSON.stringify(
    FunctionXmlUnroll$outboundSchema.parse(functionXmlUnroll),
  );
}
