...
export type ItemsTypeRoutesInputRoutes = {
  /**
...
/** @internal */
export type ItemsTypeRoutesInputRoutes$Outbound = {
  clones?: Array<{ [k: string]: string }> | undefined;
  context?: string | undefined;
  description?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const ItemsTypeRoutesInputRoutes$outboundSchema: z.ZodType<
...
export function itemsTypeRoutesInputRoutesToJSON(
  itemsTypeRoutesInputRoutes: ItemsTypeRoutesInputRoutes,
): string {
  return JSON.stringify(
    ItemsTypeRoutesInputRoutes$outboundSchema.parse(itemsTypeRoutesInputRoutes),
  );
}
