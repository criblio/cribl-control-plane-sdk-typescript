...
/** @internal */
export const FunctionLocalSearchSchemaMapper$inboundSchema: z.ZodType<
...
export function functionLocalSearchSchemaMapperFromJSON(
  jsonString: string,
): SafeParseResult<FunctionLocalSearchSchemaMapper, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FunctionLocalSearchSchemaMapper$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FunctionLocalSearchSchemaMapper' from JSON`,
  );
}
