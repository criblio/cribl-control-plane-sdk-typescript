...
export type InputUpwindHecInput = {
  /**
...
/** @internal */
export type InputUpwindHecInput$Outbound = {
  id?: string | undefined;
  type: "upwind_hec";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputUpwindHecInput$outboundSchema: z.ZodType<
...
export function inputUpwindHecInputToJSON(
  inputUpwindHecInput: InputUpwindHecInput,
): string {
  return JSON.stringify(
    InputUpwindHecInput$outboundSchema.parse(inputUpwindHecInput),
  );
}
