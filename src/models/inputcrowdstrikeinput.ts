...
export type InputCrowdstrikeInput = {
  /**
...
/** @internal */
export type InputCrowdstrikeInput$Outbound = {
  id?: string | undefined;
  type: "crowdstrike";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputCrowdstrikeInput$outboundSchema: z.ZodType<
...
export function inputCrowdstrikeInputToJSON(
  inputCrowdstrikeInput: InputCrowdstrikeInput,
): string {
  return JSON.stringify(
    InputCrowdstrikeInput$outboundSchema.parse(inputCrowdstrikeInput),
  );
}
