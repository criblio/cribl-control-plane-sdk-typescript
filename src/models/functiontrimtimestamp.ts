...
/** @internal */
export type FunctionTrimTimestamp$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionTrimTimestamp$outboundSchema: z.ZodType<
...
export function functionTrimTimestampToJSON(
  functionTrimTimestamp: FunctionTrimTimestamp,
): string {
  return JSON.stringify(
    FunctionTrimTimestamp$outboundSchema.parse(functionTrimTimestamp),
  );
}
