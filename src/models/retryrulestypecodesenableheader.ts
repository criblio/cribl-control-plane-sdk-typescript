...
export type RetryRulesTypeCodesEnableHeader = {
  /**
...
/** @internal */
export const RetryRulesTypeCodesEnableHeader$inboundSchema: z.ZodType<
...
/** @internal */
export type RetryRulesTypeCodesEnableHeader$Outbound = {
  type: string;
  interval?: number | undefined;
  limit?: number | undefined;
  multiplier?: number | undefined;
...
/** @internal */
export const RetryRulesTypeCodesEnableHeader$outboundSchema: z.ZodType<
...
export function retryRulesTypeCodesEnableHeaderToJSON(
  retryRulesTypeCodesEnableHeader: RetryRulesTypeCodesEnableHeader,
): string {
  return JSON.stringify(
    RetryRulesTypeCodesEnableHeader$outboundSchema.parse(
      retryRulesTypeCodesEnableHeader,
    ),
  );
}
export function retryRulesTypeCodesEnableHeaderFromJSON(
  jsonString: string,
): SafeParseResult<RetryRulesTypeCodesEnableHeader, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RetryRulesTypeCodesEnableHeader$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RetryRulesTypeCodesEnableHeader' from JSON`,
  );
}
