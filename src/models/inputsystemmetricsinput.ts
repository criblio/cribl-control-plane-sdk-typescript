 ...
 */
export const InputSystemMetricsContainerMode = {
  /**
   * Basic
   */
  Basic: "basic",
 ...
 * Select the level of detail for container metrics
 */
export type InputSystemMetricsContainerMode = OpenEnum<
  typeof InputSystemMetricsContainerMode
>;
...
export type InputSystemMetricsContainer = {
  /**
   * Select the level of detail for container metrics
   */
  mode?: InputSystemMetricsContainerMode | undefined;
  /**
...
export type InputSystemMetricsInput = {
  ...
  container?: InputSystemMetricsContainer | undefined;
...
/** @internal */
export const InputSystemMetricsContainerMode$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  InputSystemMetricsContainerMode
> = openEnums.outboundSchema(InputSystemMetricsContainerMode);
...
/** @internal */
export type InputSystemMetricsContainer$Outbound = {
  mode?: string | undefined;
  dockerSocket?: Array<string> | undefined;
  dockerTimeout?: number | undefined;
...
/** @internal */
export const InputSystemMetricsContainer$outboundSchema: z.ZodType<
  InputSystemMetricsContainer$Outbound,
  z.ZodTypeDef,
  InputSystemMetricsContainer
> = z.object({
  mode: InputSystemMetricsContainerMode$outboundSchema.optional(),
...
export function inputSystemMetricsContainerToJSON(
  inputSystemMetricsContainer: InputSystemMetricsContainer,
): string {
  return JSON.stringify(
    InputSystemMetricsContainer$outboundSchema.parse(
      inputSystemMetricsContainer,
    ),
  );
}
