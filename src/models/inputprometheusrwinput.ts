...
export type InputPrometheusRwInput = {
  /**
...
/** @internal */
export type InputPrometheusRwInput$Outbound = {
  id?: string | undefined;
  type: "prometheus_rw";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputPrometheusRwInput$outboundSchema: z.ZodType<
...
export function inputPrometheusRwInputToJSON(
  inputPrometheusRwInput: InputPrometheusRwInput,
): string {
  return JSON.stringify(
    InputPrometheusRwInput$outboundSchema.parse(inputPrometheusRwInput),
  );
}
