...
> = z.object({
  ...
  shardIteratorType: types.optional(ShardIteratorStart$inboundSchema),
  payloadFormat: types.optional(RecordDataFormat$inboundSchema),
  getRecordsLimit: types.optional(types.number()),
  getRecordsLimitTotal: types.optional(types.number()),
  loadBalancingAlgorithm: types.optional(ShardLoadBalancing$inboundSchema),
