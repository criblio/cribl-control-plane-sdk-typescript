...
export type FunctionMetricsExport = {
  /**
...
/** @internal */
export const FunctionMetricsExport$inboundSchema: z.ZodType<
...
export function functionMetricsExportFromJSON(
  jsonString: string,
): SafeParseResult<FunctionMetricsExport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => FunctionMetricsExport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FunctionMetricsExport' from JSON`,
  );
}
