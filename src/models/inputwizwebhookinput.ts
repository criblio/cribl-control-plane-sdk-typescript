...
export type InputWizWebhookInput = {
  /**
...
/** @internal */
export type InputWizWebhookInput$Outbound = {
  id?: string | undefined;
  type: "wiz_webhook";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputWizWebhookInput$outboundSchema: z.ZodType<
...
export function inputWizWebhookInputToJSON(
  inputWizWebhookInput: InputWizWebhookInput,
): string {
  return JSON.stringify(
    InputWizWebhookInput$outboundSchema.parse(inputWizWebhookInput),
  );
}
