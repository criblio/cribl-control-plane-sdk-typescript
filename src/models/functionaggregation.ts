...
/** @internal */
export type FunctionAggregation$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionAggregation$outboundSchema: z.ZodType<
...
export function functionAggregationToJSON(
  functionAggregation: FunctionAggregation,
): string {
  return JSON.stringify(
    FunctionAggregation$outboundSchema.parse(functionAggregation),
  );
}
