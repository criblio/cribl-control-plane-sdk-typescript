 ...
 * Endpoint name
 */
export const InputResponseEndpointName = {
 ...
 * Endpoint name
 */
export type InputResponseEndpointName = OpenEnum<
  typeof InputResponseEndpointName
>;
...
export type ContentConfigAnthropicCompliance = {
   ...
   * Endpoint name
   */
  contentType: InputResponseEndpointName;
  /**
   * Description
   */
...
/** @internal */
export const InputResponseEndpointName$inboundSchema: z.ZodType<
  InputResponseEndpointName,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(InputResponseEndpointName);
...
export const ContentConfigAnthropicCompliance$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  contentType: InputResponseEndpointName$inboundSchema,
