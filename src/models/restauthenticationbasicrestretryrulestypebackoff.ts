 ...
 */
export type RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes =
  | Array<any>
  | string;
 ...
 * Names of attributes within the response that contain next-page information
 */
export type RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes =
  | Array<any>
  | string;
...
> = discriminatedUnion("discoverType", {
  ...
  json: RestAuthenticationOauthRestDiscoveryDiscoverTypeJson$inboundSchema,
  list: RestAuthenticationOauthRestDiscoveryDiscoverTypeList$inboundSchema,
  none: RestAuthenticationOauthRestDiscoveryDiscoverTypeNone$inboundSchema,
});
/** @internal */
...
/** @internal */
export const RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$inboundSchema:
  z.ZodType<
...
/** @internal */
export type RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$Outbound =
  | Array<any>
  | string;

/** @internal */
export const RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$outboundSchema:
  z.ZodType<
    RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$Outbound,
    z.ZodTypeDef,
    RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes
  > = smartUnion([z.array(z.any()), z.string()]);

export function restAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributesToJSON(
  restAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes:
    RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes,
): string {
  return JSON.stringify(
    RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$outboundSchema
      .parse(
        restAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes,
      ),
  );
}
export function restAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributesFromJSON(
  jsonString: string,
): SafeParseResult<
  RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'RestAuthenticationOauthRestPaginationTypeResponseHeaderResponseAttributes' from JSON`,
  );
}
...
/** @internal */
export const RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$inboundSchema:
  z.ZodType<
  ...
  > = smartUnion([z.array(z.any()), types.string()]);
/** @internal */
export type RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$Outbound =
  | Array<any>
  | string;

/** @internal */
export const RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$outboundSchema:
  z.ZodType<
    RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$Outbound,
    z.ZodTypeDef,
    RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes
  > = smartUnion([z.array(z.any()), z.string()]);

export function restAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributesToJSON(
  restAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes:
    RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes,
): string {
  return JSON.stringify(
    RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$outboundSchema
      .parse(
        restAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes,
      ),
  );
}
export function restAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributesFromJSON(
  jsonString: string,
): SafeParseResult<
  RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'RestAuthenticationOauthRestPaginationTypeResponseBodyResponseAttributes' from JSON`,
  );
}
