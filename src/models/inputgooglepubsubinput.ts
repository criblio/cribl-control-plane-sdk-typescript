...
export type InputGooglePubsubInput = {
  /**
...
/** @internal */
export type InputGooglePubsubInput$Outbound = {
  id?: string | undefined;
  type: "google_pubsub";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputGooglePubsubInput$outboundSchema: z.ZodType<
...
export function inputGooglePubsubInputToJSON(
  inputGooglePubsubInput: InputGooglePubsubInput,
): string {
  return JSON.stringify(
    InputGooglePubsubInput$outboundSchema.parse(inputGooglePubsubInput),
  );
}
