...
export type InputZscalerHecInput = {
  /**
   * Unique ID for this input
   */
  id?: string | undefined;
...
> = z.object({
  ...
  authTokens: types.optional(
    z.array(z.lazy(() => InputZscalerHecAuthToken$inboundSchema)),
  ),
...
/** @internal */
export type InputZscalerHecInput$Outbound = {
  id?: string | undefined;
  type: "zscaler_hec";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputZscalerHecInput$outboundSchema: z.ZodType<
...
export function inputZscalerHecInputToJSON(
  inputZscalerHecInput: InputZscalerHecInput,
): string {
  return JSON.stringify(
    InputZscalerHecInput$outboundSchema.parse(inputZscalerHecInput),
  );
}
