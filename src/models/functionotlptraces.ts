...
/** @internal */
export type FunctionOtlpTraces$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionOtlpTraces$outboundSchema: z.ZodType<
...
export function functionOtlpTracesToJSON(
  functionOtlpTraces: FunctionOtlpTraces,
): string {
  return JSON.stringify(
    FunctionOtlpTraces$outboundSchema.parse(functionOtlpTraces),
  );
}
