...
export type InputConfluentCloudInput = {
  /**
...
/** @internal */
export type InputConfluentCloudInput$Outbound = {
  id?: string | undefined;
  type: "confluent_cloud";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputConfluentCloudInput$outboundSchema: z.ZodType<
...
export function inputConfluentCloudInputToJSON(
  inputConfluentCloudInput: InputConfluentCloudInput,
): string {
  return JSON.stringify(
    InputConfluentCloudInput$outboundSchema.parse(inputConfluentCloudInput),
  );
}
