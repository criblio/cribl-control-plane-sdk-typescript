...
export type InputS3InventoryInput = {
  /**
...
/** @internal */
export type InputS3InventoryInput$Outbound = {
  id?: string | undefined;
  type: "s3_inventory";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputS3InventoryInput$outboundSchema: z.ZodType<
...
export function inputS3InventoryInputToJSON(
  inputS3InventoryInput: InputS3InventoryInput,
): string {
  return JSON.stringify(
    InputS3InventoryInput$outboundSchema.parse(inputS3InventoryInput),
  );
}
