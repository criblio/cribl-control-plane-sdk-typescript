...
export type InputFirehoseInput = {
  /**
...
/** @internal */
export type InputFirehoseInput$Outbound = {
  id?: string | undefined;
  type: "firehose";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputFirehoseInput$outboundSchema: z.ZodType<
...
export function inputFirehoseInputToJSON(
  inputFirehoseInput: InputFirehoseInput,
): string {
  return JSON.stringify(
    InputFirehoseInput$outboundSchema.parse(inputFirehoseInput),
  );
}
