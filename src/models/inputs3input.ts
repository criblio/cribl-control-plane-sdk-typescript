...
/** @internal */
export type InputS3Input$Outbound = {
  id?: string | undefined;
  type: "s3";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputS3Input$outboundSchema: z.ZodType<
...
export function inputS3InputToJSON(inputS3Input: InputS3Input): string {
  return JSON.stringify(InputS3Input$outboundSchema.parse(inputS3Input));
}
