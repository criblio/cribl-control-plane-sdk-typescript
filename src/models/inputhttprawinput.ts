...
/** @internal */
export type InputHttpRawInput$Outbound = {
  id?: string | undefined;
  type: "http_raw";
  disabled?: boolean | undefined;
  pipeline?: string | undefined;
...
/** @internal */
export const InputHttpRawInput$outboundSchema: z.ZodType<
...
export function inputHttpRawInputToJSON(
  inputHttpRawInput: InputHttpRawInput,
): string {
  return JSON.stringify(
    InputHttpRawInput$outboundSchema.parse(inputHttpRawInput),
  );
}
