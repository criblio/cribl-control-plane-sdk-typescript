...
/** @internal */
export type FunctionComment$Outbound = {
  __filename: string;
  asyncTimeout?: number | undefined;
  cribl_version?: string | undefined;
  disabled?: boolean | undefined;
...
/** @internal */
export const FunctionComment$outboundSchema: z.ZodType<
...
export function functionCommentToJSON(
  functionComment: FunctionComment,
): string {
  return JSON.stringify(FunctionComment$outboundSchema.parse(functionComment));
}
