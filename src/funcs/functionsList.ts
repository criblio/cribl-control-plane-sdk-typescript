...
export function functionsList(
  ...
  PageIterator<
    Result<
      operations.GetFunctionsResponse,
      | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFunctionsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFunctionsResponse$inboundSchema, {
      key: "Result",
    }),
