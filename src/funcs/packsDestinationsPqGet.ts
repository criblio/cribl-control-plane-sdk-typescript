 ...
 */
export function packsDestinationsPqGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOutputSystemPqByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/system/outputs/{id}/pq")(pathParams);
