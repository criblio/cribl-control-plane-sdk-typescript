 ...
 */
export function versionsCommitsDiff(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetVersionDiffRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/version/diff")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedGitDiffResult$inboundSchema),
