 ...
 */
export function packsRoutesList(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRoutesByPackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/p/{pack}/routes")(pathParams);
