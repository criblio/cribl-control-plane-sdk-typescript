 ...
 */
export function packsDestinationsUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateOutputSystemByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/system/outputs/{id}")(pathParams);
