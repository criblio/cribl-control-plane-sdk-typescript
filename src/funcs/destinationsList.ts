...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListOutputRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/system/outputs")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListOutputResponse$inboundSchema, { key: "Result" }),
