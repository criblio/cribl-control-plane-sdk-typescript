 ...
 * Update a Dataset in the specified Lake
 */
export function lakeUpdateCriblLakeDatasetByLakeIdAndId(
  client: CriblControlPlaneCore,
  request: operations.UpdateCriblLakeDatasetByLakeIdAndIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateCriblLakeDatasetByLakeIdAndIdResponse,
    | errors.ErrorT
...
> {
  ...
  >(
    M.json(
      200,
      operations.UpdateCriblLakeDatasetByLakeIdAndIdResponse$inboundSchema,
    ),
