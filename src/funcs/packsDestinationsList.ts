 ...
 */
export function packsDestinationsList(
  ...
  PageIterator<
    Result<
      operations.GetOutputSystemByPackResponse,
      | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOutputSystemByPackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/p/{pack}/system/outputs")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOutputSystemByPackResponse$inboundSchema, {
      key: "Result",
    }),
