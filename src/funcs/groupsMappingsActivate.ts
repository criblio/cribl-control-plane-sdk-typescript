...
> {
  ...
  const body = encodeJSON("body", payload.RulesetId, { explode: true });
  ...
  const path = pathToFunc("/admin/products/{product}/mappings/activate")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedRulesetId$inboundSchema),
