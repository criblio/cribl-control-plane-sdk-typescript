 ...
 */
export function packsDestinationsSamplesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOutputSystemSamplesByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/system/outputs/{id}/samples")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedOutputSamplesResponse$inboundSchema),
