 ...
 */
export function databaseConnectionsCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.DatabaseConnectionConfig$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/lib/database-connections")();
