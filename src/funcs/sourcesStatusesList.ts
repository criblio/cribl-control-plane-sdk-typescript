 ...
 */
export function sourcesStatusesList(
  ...
  PageIterator<
    Result<
      operations.GetInputStatusResponse,
      | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInputStatusRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/system/status/inputs")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetInputStatusResponse$inboundSchema, {
      key: "Result",
    }),
