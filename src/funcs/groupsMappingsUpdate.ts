 ...
 */
export function groupsMappingsUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateAdminProductsMappingsByProductAndIdRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/admin/products/{product}/mappings/{id}")(
    pathParams,
  );
