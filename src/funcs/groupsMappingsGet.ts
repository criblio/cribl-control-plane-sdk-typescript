 ...
 */
export function groupsMappingsGet(
  client: CriblControlPlaneCore,
  request: operations.GetAdminProductsMappingsByProductAndIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAdminProductsMappingsByProductAndIdResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAdminProductsMappingsByProductAndIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.GetAdminProductsMappingsByProductAndIdResponse$inboundSchema,
    ),
