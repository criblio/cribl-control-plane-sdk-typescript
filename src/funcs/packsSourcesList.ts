 ...
 */
export function packsSourcesList(
  ...
  PageIterator<
    Result<
      operations.GetInputSystemByPackResponse,
      | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInputSystemByPackRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetInputSystemByPackResponse$inboundSchema, {
      key: "Result",
    }),
