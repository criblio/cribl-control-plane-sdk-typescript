...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInputStatusSystemInputsByPackRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetInputStatusSystemInputsByPackResponse$inboundSchema,
      { key: "Result" },
    ),
