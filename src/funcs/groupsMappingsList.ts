 ...
 */
export function groupsMappingsList(
  client: CriblControlPlaneCore,
  request: operations.GetAdminProductsMappingsByProductRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAdminProductsMappingsByProductResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAdminProductsMappingsByProductRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetAdminProductsMappingsByProductResponse$inboundSchema,
    ),
