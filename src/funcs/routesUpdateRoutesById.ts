 ...
 * Update Routes
 */
export function routesUpdateRoutesById(
  client: CriblControlPlaneCore,
  request: operations.UpdateRoutesByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateRoutesByIdResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateRoutesByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateRoutesByIdResponse$inboundSchema),
