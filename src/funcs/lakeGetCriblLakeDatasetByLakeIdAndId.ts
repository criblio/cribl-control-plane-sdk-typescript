 ...
 * Get a Dataset in the specified Lake
 */
export function lakeGetCriblLakeDatasetByLakeIdAndId(
  client: CriblControlPlaneCore,
  request: operations.GetCriblLakeDatasetByLakeIdAndIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCriblLakeDatasetByLakeIdAndIdResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCriblLakeDatasetByLakeIdAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetCriblLakeDatasetByLakeIdAndIdResponse$inboundSchema,
    ),
