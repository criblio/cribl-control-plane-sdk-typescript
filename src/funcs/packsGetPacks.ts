 ...
 * Get info on packs
 */
export function packsGetPacks(
  client: CriblControlPlaneCore,
  request?: operations.GetPacksRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetPacksResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPacksRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPacksResponse$inboundSchema),
