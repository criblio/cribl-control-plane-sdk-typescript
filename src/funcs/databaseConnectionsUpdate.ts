 ...
 */
export function databaseConnectionsUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateDatabaseConnectionConfigByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.DatabaseConnectionConfig, {
    explode: true,
  });
  ...
  const path = pathToFunc("/lib/database-connections/{id}")(pathParams);
  ...
  >(
    ...
    M.jsonErr([400, 404], errors.RestApiJsonError$inboundSchema),
