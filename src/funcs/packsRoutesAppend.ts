 ...
 */
export function packsRoutesAppend(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateRoutesAppendByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/routes/{id}/append")(pathParams);
