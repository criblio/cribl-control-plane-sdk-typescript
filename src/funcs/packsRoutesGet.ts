 ...
 */
export function packsRoutesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRoutesByPackAndIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/p/{pack}/routes/{id}")(pathParams);
