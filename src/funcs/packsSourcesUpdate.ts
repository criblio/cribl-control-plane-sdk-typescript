 ...
 */
export function packsSourcesUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateInputSystemByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/system/inputs/{id}")(pathParams);
