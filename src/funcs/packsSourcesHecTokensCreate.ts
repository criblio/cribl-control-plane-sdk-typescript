 ...
 */
export function packsSourcesHecTokensCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateInputSystemHecTokenByPackAndIdRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/p/{pack}/system/inputs/{id}/hectoken")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedInputSplunkHec$inboundSchema),
