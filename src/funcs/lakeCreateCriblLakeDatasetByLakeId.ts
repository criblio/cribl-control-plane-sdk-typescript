 ...
 * Create a Dataset in the specified Lake
 */
export function lakeCreateCriblLakeDatasetByLakeId(
  client: CriblControlPlaneCore,
  request: operations.CreateCriblLakeDatasetByLakeIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateCriblLakeDatasetByLakeIdResponse,
    | errors.ErrorT
...
> {
  ...
  >(
    M.json(
      200,
      operations.CreateCriblLakeDatasetByLakeIdResponse$inboundSchema,
    ),
