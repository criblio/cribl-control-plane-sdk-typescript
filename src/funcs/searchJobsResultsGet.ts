 ...
 * List search results, when lower/upper bound is provided, offset is relative to the time range.
 */
export function searchJobsResultsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSearchJobsResultsByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/search/jobs/{id}/results")(pathParams);
