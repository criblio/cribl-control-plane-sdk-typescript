 ...
 */
export function packsPipelinesDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletePipelinesByPackAndIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/p/{pack}/pipelines/{id}")(pathParams);
