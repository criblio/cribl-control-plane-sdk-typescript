...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateRoutesAppendByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/routes/{id}/append")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedListRoutes$inboundSchema),
