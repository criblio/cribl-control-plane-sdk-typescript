...
export function pipelinesList(
  ...
  PageIterator<
    Result<
      operations.GetPipelinesResponse,
      | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPipelinesRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPipelinesResponse$inboundSchema, {
      key: "Result",
    }),
