 ...
 */
export function sourcesStatusesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInputStatusByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/system/status/inputs/{id}")(pathParams);
