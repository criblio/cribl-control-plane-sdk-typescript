 ...
 */
export function packsDestinationsStatusesGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOutputStatusSystemOutputsByPackAndIdRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/p/{pack}/system/status/outputs/{id}")(pathParams);
