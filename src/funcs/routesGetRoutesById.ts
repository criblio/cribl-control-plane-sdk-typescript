 ...
 * Get Routes by ID
 */
export function routesGetRoutesById(
  client: CriblControlPlaneCore,
  request: operations.GetRoutesByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetRoutesByIdResponse,
    | errors.ErrorT
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRoutesByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetRoutesByIdResponse$inboundSchema),
