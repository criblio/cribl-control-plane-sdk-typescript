 ...
 */
export function packsDestinationsSamplesCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateOutputSystemTestByPackAndIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/p/{pack}/system/outputs/{id}/test")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedOutputTestResponse$inboundSchema),
