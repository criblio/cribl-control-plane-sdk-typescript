...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdatePacksByIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PackUpgradeRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CountedListPackInfo$inboundSchema),
