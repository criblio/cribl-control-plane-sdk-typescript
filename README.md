...
```bash
npm add https://github.com/criblio/cribl-control-plane-sdk-typescript
```

### PNPM

```bash
pnpm add https://github.com/criblio/cribl-control-plane-sdk-typescript
```

### Bun

```bash
bun add https://github.com/criblio/cribl-control-plane-sdk-typescript
```

### Yarn

```bash
yarn add https://github.com/criblio/cribl-control-plane-sdk-typescript zod
