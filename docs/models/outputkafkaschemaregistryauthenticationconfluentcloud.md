...
```typescript
import { OutputKafkaSchemaRegistryAuthenticationConfluentCloud } from "cribl-control-plane/models";

let value: OutputKafkaSchemaRegistryAuthenticationConfluentCloud = {
  auth: {
  ...
  defaultKeySchemaId: 3090.34,
  defaultValueSchemaId: 8702.07,
};
```
...
| `auth`                                                                                                                                           | [models.OutputAuthConfluentCloud](../models/outputauthconfluentcloud.md)                                                                         | :heavy_minus_sign:                                                                                                                               | Credentials to use when authenticating with the schema registry using basic HTTP authentication                                                  |
| `tls`                                                                                                                                            | [models.OutputKafkaSchemaRegistryTLSSettingsClientSideConfluentCloud](../models/outputkafkaschemaregistrytlssettingsclientsideconfluentcloud.md) | :heavy_minus_sign:                                                                                                                               | N/A                                                                                                                                              |
