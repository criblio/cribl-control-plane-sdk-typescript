...
```typescript
import { OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint8 } from "cribl-control-plane/models";

let value: OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint8 =
