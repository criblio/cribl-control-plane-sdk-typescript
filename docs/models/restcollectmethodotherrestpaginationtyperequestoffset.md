...
```typescript
import { RestCollectMethodOtherRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestPaginationTypeRequestOffset = {
  type: "request_offset",
  offsetField: "<value>",
  offset: 2284.41,
  limitField: "<value>",
