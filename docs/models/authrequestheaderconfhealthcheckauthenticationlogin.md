...
```typescript
import { AuthRequestHeaderConfHealthCheckAuthenticationLogin } from "cribl-control-plane/models";

let value: AuthRequestHeaderConfHealthCheckAuthenticationLogin = {
  name: "<value>",
  value: "<value>",
};
```
