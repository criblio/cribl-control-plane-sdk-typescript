...
```typescript
import { CollectorRestRetryRules1 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules1 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.CollectorRestRetryType1](../models/collectorrestretrytype1.md) | :heavy_minus_sign:                                                     | Algorithm to use when performing HTTP retries                          |
