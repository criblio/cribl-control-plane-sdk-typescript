...
```typescript
import { RestCollectMethodPostWithBodyRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestCollectMethodPostWithBodyRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [
    "<value 1>",
  ],
