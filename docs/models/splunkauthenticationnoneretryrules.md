...
```typescript
import { SplunkAuthenticationNoneRetryRules } from "cribl-control-plane/models";

let value: SplunkAuthenticationNoneRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `type`                                                                                     | [models.SplunkAuthenticationNoneRetryType](../models/splunkauthenticationnoneretrytype.md) | :heavy_minus_sign:                                                                         | Algorithm to use when performing HTTP retries                                              |
