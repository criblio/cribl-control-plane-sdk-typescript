...
| `enableAcceleration`                                                                                                                   | *boolean*                                                                                                                              | :heavy_check_mark:                                                                                                                     | If <code>true</code>, the system automatically backfills and refreshes Dataset metadata. Otherwise, <code>false</code>.                |                                                                                                                                        |
