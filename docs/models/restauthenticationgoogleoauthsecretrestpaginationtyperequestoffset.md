...
```typescript
import { RestAuthenticationGoogleOauthSecretRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestAuthenticationGoogleOauthSecretRestPaginationTypeRequestOffset =
  {
    type: "request_offset",
    offsetField: "<value>",
    offset: 3299.64,
