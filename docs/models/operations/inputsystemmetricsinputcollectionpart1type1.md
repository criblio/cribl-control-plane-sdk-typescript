...
```typescript
import { InputSystemMetricsInputCollectionPart1Type1 } from "cribl-control-plane/models/operations";
...
let value: InputSystemMetricsInputCollectionPart1Type1 = {
  ...
  persistence: {},
  description: "among sightseeing precedent downshift apt deer vice space",
};
```
