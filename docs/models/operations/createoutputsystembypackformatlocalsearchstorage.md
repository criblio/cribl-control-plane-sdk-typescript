...
```typescript
import { CreateOutputSystemByPackFormatLocalSearchStorage } from "cribl-control-plane/models/operations";

let value: CreateOutputSystemByPackFormatLocalSearchStorage = "json-each-row";
```
