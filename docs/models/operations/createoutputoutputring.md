...
```typescript
import { CreateOutputOutputRing } from "cribl-control-plane/models/operations";

let value: CreateOutputOutputRing = {
  id: "<id>",
  type: "ring",
  pipeline: "<value>",
  systemFields: [
...
| `format`                                                                                                                         | [operations.CreateOutputDataFormatRing](../../models/operations/createoutputdataformatring.md)                                   | :heavy_minus_sign:                                                                                                               | Format of the output data.                                                                                                       |
