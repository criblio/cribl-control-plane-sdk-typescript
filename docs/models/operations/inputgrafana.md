...
const value: operations.InputGrafanaGrafana2 = {
  ...
  prometheusAuth: {
    username: "Abbie50",
    password: "rcrLARJiPnD6_4y",
    token: "<value>",
    credentialsSecret: "<value>",
    textSecret: "<value>",
    loginUrl: "https://inconsequential-airmail.net/",
    secretParamName: "<value>",
    secret: "<value>",
    tokenAttributeName: "<value>",
    oauthParams: [
  ...
  lokiAuth: {
    username: "Lizeth29",
    password: "i18jxjkswNioVZZ",
    token: "<value>",
    credentialsSecret: "<value>",
    textSecret: "<value>",
    loginUrl: "https://angelic-caption.com/",
    secretParamName: "<value>",
    secret: "<value>",
    tokenAttributeName: "<value>",
    oauthParams: [
  ...
  description:
    "hype playfully question whether aha gleefully stint but gaseous",
};
```
