...
```typescript
import { InputWindowsMetricsSendToRoutesTrueConstraint } from "cribl-control-plane/models/operations";

let value: InputWindowsMetricsSendToRoutesTrueConstraint = {
  sendToRoutes: false,
  id: "<id>",
