...
```typescript
import { CreateInputChats } from "cribl-control-plane/models/operations";

let value: CreateInputChats = {};
```
...
| `manageState`                                                                                    | [operations.CreateInputChatsManageState](../../models/operations/createinputchatsmanagestate.md) | :heavy_minus_sign:                                                                               | N/A                                                                                              |