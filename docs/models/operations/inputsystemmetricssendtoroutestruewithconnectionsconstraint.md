...
```typescript
import { InputSystemMetricsSendToRoutesTrueWithConnectionsConstraint } from "cribl-control-plane/models/operations";

let value: InputSystemMetricsSendToRoutesTrueWithConnectionsConstraint = {
  connections: [
    {
      pipeline: "<value>",
      output: "<value>",
