...
let value: CreateOutputAuthenticationKafka = {
  username: "Zachary_Will6",
  password: "6nNMS3M6Nh1PpTz",
  credentialsSecret: "<value>",
  keytabLocation: "<value>",
  principal: "<value>",
  brokerServiceClass: "<value>",
  tokenUrl: "https://regal-soup.net",
  clientId: "<id>",
...
| `authType`                                                                                                           | [operations.CreateOutputAuthenticationMethodKafka](../../models/operations/createoutputauthenticationmethodkafka.md) | :heavy_minus_sign:                                                                                                   | Enter credentials directly, or select a stored secret                                                                |
...
| `oauthParams`                                                                                                        | [operations.CreateOutputOauthParamKafka](../../models/operations/createoutputoauthparamkafka.md)[]                   | :heavy_minus_sign:                                                                                                   | Additional fields to send to the token endpoint, such as scope or audience                                           |
| `saslExtensions`                                                                                                     | [operations.CreateOutputSaslExtensionKafka](../../models/operations/createoutputsaslextensionkafka.md)[]             | :heavy_minus_sign:                                                                                                   | Additional SASL extension fields, such as Confluent's logicalCluster or identityPoolId                               |