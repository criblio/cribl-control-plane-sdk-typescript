...
```typescript
import { CreateOutputSystemByPackEndpointGoogleCloudObservability } from "cribl-control-plane/models/operations";

let value: CreateOutputSystemByPackEndpointGoogleCloudObservability =
