...
```typescript
import { DiskSpoolingKubeLogs } from "cribl-control-plane/models/operations";

let value: DiskSpoolingKubeLogs = {};
```
...
| `compress`                                                                                                      | [operations.PersistenceCompressionKubeLogs](../../models/operations/persistencecompressionkubelogs.md)          | :heavy_minus_sign:                                                                                              | Data compression format. Default is gzip.                                                                       |