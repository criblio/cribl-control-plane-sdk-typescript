...
```typescript
import { DeleteSearchDashboardSearchByPackAndIdResponse } from "cribl-control-plane/models/operations";

let value: DeleteSearchDashboardSearchByPackAndIdResponse = {
  count: 731067,
  items: [
    {
