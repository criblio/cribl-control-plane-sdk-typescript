...
### `operations.InputConfluentCloudSendToRoutesTrueConstraint`

```typescript
const value: operations.InputConfluentCloudSendToRoutesTrueConstraint = {
  id: "<id>",
...
### `operations.InputConfluentCloudPqEnabledFalseConstraint`

```typescript
const value: operations.InputConfluentCloudPqEnabledFalseConstraint = {
  id: "<id>",
  type: "confluent_cloud",
  pipeline: "<value>",
  environment: "<value>",
