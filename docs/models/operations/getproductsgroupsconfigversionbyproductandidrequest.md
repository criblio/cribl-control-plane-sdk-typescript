...
```typescript
import { GetProductsGroupsConfigVersionByProductAndIdRequest } from "cribl-control-plane/models/operations";

let value: GetProductsGroupsConfigVersionByProductAndIdRequest = {
  product: "outpost",
  id: "<id>",
};
```
