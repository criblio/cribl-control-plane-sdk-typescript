...
```typescript
import { CreateInputDiskSystemMetrics } from "cribl-control-plane/models/operations";

let value: CreateInputDiskSystemMetrics = {
  mode: "custom",
  detail: false,
  inodes: true,
  devices: [
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mode`                                                                                                                                                                            | [operations.CreateInputDiskModeSystemMetrics](../../models/operations/createinputdiskmodesystemmetrics.md)                                                                        | :heavy_minus_sign:                                                                                                                                                                | Select the level of detail for disk metrics                                                                                                                                       |
