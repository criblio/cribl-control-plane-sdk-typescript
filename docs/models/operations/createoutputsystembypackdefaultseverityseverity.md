...
```typescript
import { CreateOutputSystemByPackDefaultSeveritySeverity } from "cribl-control-plane/models/operations";

let value: CreateOutputSystemByPackDefaultSeveritySeverity = "info";
```
