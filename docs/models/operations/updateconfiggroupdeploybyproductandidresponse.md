...
```typescript
import { UpdateConfigGroupDeployByProductAndIdResponse } from "cribl-control-plane/models/operations";

let value: UpdateConfigGroupDeployByProductAndIdResponse = {
  count: 473056,
  items: [
    {
      cloud: {
