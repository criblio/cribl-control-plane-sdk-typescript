...
```typescript
import { CreateOutputSystemByPackOutputRing } from "cribl-control-plane/models/operations";
...
| `format`                                                                                                                         | [operations.CreateOutputSystemByPackDataFormatRing](../../models/operations/createoutputsystembypackdataformatring.md)           | :heavy_minus_sign:                                                                                                               | Format of the output data.                                                                                                       |
