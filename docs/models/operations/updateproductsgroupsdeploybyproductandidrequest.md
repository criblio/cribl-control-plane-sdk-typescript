...
```typescript
import { UpdateProductsGroupsDeployByProductAndIdRequest } from "cribl-control-plane/models/operations";

let value: UpdateProductsGroupsDeployByProductAndIdRequest = {
  product: "stream",
  id: "<id>",
  deployRequest: {
    version: "<value>",
