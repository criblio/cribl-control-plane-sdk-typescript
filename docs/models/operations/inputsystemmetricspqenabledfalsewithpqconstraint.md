...
```typescript
import { InputSystemMetricsPqEnabledFalseWithPqConstraint } from "cribl-control-plane/models/operations";

let value: InputSystemMetricsPqEnabledFalseWithPqConstraint = {
  pq: {
    pqControls: {},
  },
  id: "<id>",
