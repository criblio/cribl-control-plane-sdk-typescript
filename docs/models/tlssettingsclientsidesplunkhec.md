...
```typescript
import { TLSSettingsClientSideSplunkHec } from "cribl-control-plane/models";
...
| `minVersion`                                                                                                      | [models.OutputMinimumTLSVersionSplunkHec](../models/outputminimumtlsversionsplunkhec.md)                          | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |
| `maxVersion`                                                                                                      | [models.OutputMaximumTLSVersionSplunkHec](../models/outputmaximumtlsversionsplunkhec.md)                          | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |