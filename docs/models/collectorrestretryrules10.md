...
```typescript
import { CollectorRestRetryRules10 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules10 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `type`                                                                   | [models.CollectorRestRetryType10](../models/collectorrestretrytype10.md) | :heavy_minus_sign:                                                       | Algorithm to use when performing HTTP retries                            |
