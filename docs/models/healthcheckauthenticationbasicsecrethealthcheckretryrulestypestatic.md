...
```typescript
import { HealthCheckAuthenticationBasicSecretHealthCheckRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationBasicSecretHealthCheckRetryRulesTypeStatic =
  {
    type: "static",
    interval: "<value>",
    limit: "<value>",
