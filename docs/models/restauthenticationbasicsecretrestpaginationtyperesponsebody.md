...
```typescript
import { RestAuthenticationBasicSecretRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationBasicSecretRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [
    "<value 1>",
  ],
