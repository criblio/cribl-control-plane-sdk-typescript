...
```typescript
import { RestCollectMethodPostRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestCollectMethodPostRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
