...
```typescript
import { DiskSpoolingKubeLogs } from "cribl-control-plane/models";
...
| `compress`                                                                                                      | [models.PersistenceCompressionKubeLogs](../models/persistencecompressionkubelogs.md)                            | :heavy_minus_sign:                                                                                              | Data compression format. Default is gzip.                                                                       |