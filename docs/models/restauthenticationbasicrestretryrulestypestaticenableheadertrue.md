...
```typescript
import { RestAuthenticationBasicRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
