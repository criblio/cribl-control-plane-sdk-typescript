...
```typescript
import { Target11 } from "cribl-control-plane/models";

let value: Target11 = {
  host: "distorted-bob.com",
};
```
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `protocol`                                                  | [models.Protocol11](../models/protocol11.md)                | :heavy_minus_sign:                                          | Protocol to use when collecting metrics                     |
