...
```typescript
import { DiskSpoolingEdgePrometheus } from "cribl-control-plane/models";
...
| `compress`                                                                                                      | [models.PersistenceCompressionEdgePrometheus](../models/persistencecompressionedgeprometheus.md)                | :heavy_minus_sign:                                                                                              | Data compression format. Default is gzip.                                                                       |