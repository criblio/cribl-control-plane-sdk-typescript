...
```typescript
import { SNMPv3Authentication4 } from "cribl-control-plane/models";

let value: SNMPv3Authentication4 = {
  v3Users: [
    {
      name: "<value>",
      authKey: "<value>",
...
| `v3Users`                                                                                                            | [models.V3User4](../models/v3user4.md)[]                                                                             | :heavy_minus_sign:                                                                                                   | User credentials for receiving v3 traps                                                                              |