...
| `logLevel`                                                                                                                                   | [models.LogLevelOptionsRunnableJobCollectionScheduleRun](../models/logleveloptionsrunnablejobcollectionschedulerun.md)                       | :heavy_minus_sign:                                                                                                                           | Level at which to set task logging                                                                                                           |
