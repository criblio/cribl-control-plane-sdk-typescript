...
```typescript
import { RestAuthenticationHmacRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationHmacRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
