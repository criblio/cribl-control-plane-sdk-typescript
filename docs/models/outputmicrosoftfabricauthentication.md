...
```typescript
import { OutputMicrosoftFabricAuthentication } from "cribl-control-plane/models";
...
| `clientSecretAuthType`                                                                                                     | [models.OutputMicrosoftFabricAuthenticationMethod](../models/outputmicrosoftfabricauthenticationmethod.md)                 | :heavy_minus_sign:                                                                                                         | N/A                                                                                                                        |
