...
```typescript
import { HealthCheckAuthenticationOauthHealthCheckRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationOauthHealthCheckRetryRulesTypeStatic = {
  type: "static",
  interval: "<value>",
  limit: "<value>",
  codes: "<value>",
