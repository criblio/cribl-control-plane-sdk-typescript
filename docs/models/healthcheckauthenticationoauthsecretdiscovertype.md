...
```typescript
import { HealthCheckAuthenticationOauthSecretDiscoverType } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationOauthSecretDiscoverType = "list";
```
