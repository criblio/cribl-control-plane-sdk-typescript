...
```typescript
const value: models.InputTcpInputCollectionPart0Type = {
  id: "<id>",
  type: "tcp",
  pipeline: "<value>",
  environment: "<value>",
...
```typescript
const value: models.InputTcpInputCollectionPart1Type = {
  connections: [
    {
      pipeline: "<value>",
      output: "<value>",
...
```typescript
const value: models.InputTcpInputCollectionPart0Type1 = {
  id: "<id>",
  type: "tcp",
  pipeline: "<value>",
  environment: "<value>",
...
```typescript
const value: models.InputTcpInputCollectionPart1Type1 = {
  pq: {
    pqControls: {},
  },
  id: "<id>",
