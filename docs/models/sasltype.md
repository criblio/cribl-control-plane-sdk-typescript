...
```typescript
import { SaslType } from "cribl-control-plane/models";

let value: SaslType = {
  username: "Laurine58",
  password: "Nbu6BgEurWhBqwj",
  credentialsSecret: "<value>",
  keytabLocation: "<value>",
  principal: "<value>",
  brokerServiceClass: "<value>",
  tokenUrl: "https://faint-hello.info/",
  clientId: "<id>",
...
| `authType`                                                                             | [models.SaslTypeAuthenticationMethod](../models/sasltypeauthenticationmethod.md)       | :heavy_minus_sign:                                                                     | Enter credentials directly, or select a stored secret                                  |
| `credentialsSecret`                                                                    | *string*                                                                               | :heavy_minus_sign:                                                                     | Select or create a secret that references your credentials                             |
| `mechanism`                                                                            | [models.SASLTypeSASLMechanism](../models/sasltypesaslmechanism.md)                     | :heavy_minus_sign:                                                                     | N/A                                                                                    |
...
| `oauthParams`                                                                          | [models.SaslTypeOauthParam](../models/sasltypeoauthparam.md)[]                         | :heavy_minus_sign:                                                                     | Additional fields to send to the token endpoint, such as scope or audience             |
| `saslExtensions`                                                                       | [models.SaslExtension](../models/saslextension.md)[]                                   | :heavy_minus_sign:                                                                     | Additional SASL extension fields, such as Confluent's logicalCluster or identityPoolId |