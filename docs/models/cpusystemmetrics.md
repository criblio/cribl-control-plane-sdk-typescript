...
```typescript
import { CpuSystemMetrics } from "cribl-control-plane/models";
...
| ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| `mode`                                                           | [models.CpuModeSystemMetrics](../models/cpumodesystemmetrics.md) | :heavy_minus_sign:                                               | Select the level of detail for CPU metrics                       |
