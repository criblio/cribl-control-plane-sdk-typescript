...
```typescript
import { HealthCheckAuthenticationBasicSecretDiscoverType } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationBasicSecretDiscoverType = "none";
```
