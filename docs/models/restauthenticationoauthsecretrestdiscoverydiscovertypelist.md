...
```typescript
import { RestAuthenticationOauthSecretRestDiscoveryDiscoverTypeList } from "cribl-control-plane/models";

let value: RestAuthenticationOauthSecretRestDiscoveryDiscoverTypeList = {
  discoverType: "list",
  itemList: [
    "<value 1>",
  ],
