...
```typescript
import { RestAuthenticationLoginGetAuthTokenFromHeaderFalseRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationLoginGetAuthTokenFromHeaderFalseRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
