...
```typescript
import { SplunkAuthenticationTokenSplunkRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: SplunkAuthenticationTokenSplunkRetryRulesTypeBackoff = {
  type: "backoff",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
