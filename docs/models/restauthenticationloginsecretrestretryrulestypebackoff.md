...
```typescript
import { RestAuthenticationLoginSecretRestRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: RestAuthenticationLoginSecretRestRetryRulesTypeBackoff = {
  type: "backoff",
};
```
