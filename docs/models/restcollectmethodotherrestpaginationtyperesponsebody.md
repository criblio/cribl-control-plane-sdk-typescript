...
```typescript
import { RestCollectMethodOtherRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [],
  maxPages: 6523.2,
};
...
| `attribute`                                                                                                                                                   | *models.RestCollectMethodOtherRestPaginationTypeResponseBodyResponseAttributes*                                                                               | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
