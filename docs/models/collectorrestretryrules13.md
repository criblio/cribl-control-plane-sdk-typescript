...
```typescript
import { CollectorRestRetryRules13 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules13 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `type`                                                                   | [models.CollectorRestRetryType13](../models/collectorrestretrytype13.md) | :heavy_minus_sign:                                                       | Algorithm to use when performing HTTP retries                            |
