...
| `flags`                                                                                                | [models.FunctionConfSchemaMaskFlag](../models/functionconfschemamaskflag.md)[]                         | :heavy_minus_sign:                                                                                     | Fields to evaluate if one or more masking rules are matched                                            |