...
```typescript
import { RestAuthenticationHmacRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationHmacRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
