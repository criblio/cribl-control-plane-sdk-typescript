...
```typescript
import { OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint3 } from "cribl-control-plane/models";

let value: OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint3 =
