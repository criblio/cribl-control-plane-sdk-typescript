...
```typescript
import { FunctionDropDimensionsSchema } from "cribl-control-plane/models";

let value: FunctionDropDimensionsSchema = {
  dropDimensions: [
    "<value 1>",
    "<value 2>",
  ],
...
| `dropDimensions`                                                                                                                                   | *string*[]                                                                                                                                         | :heavy_minus_sign:                                                                                                                                 | One or more dimensions to be dropped. Supports wildcard expressions. Warning: Using wildcard '*' causes all dimensions in the event to be dropped. |
