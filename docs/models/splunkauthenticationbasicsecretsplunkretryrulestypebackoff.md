...
```typescript
import { SplunkAuthenticationBasicSecretSplunkRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: SplunkAuthenticationBasicSecretSplunkRetryRulesTypeBackoff = {
  type: "backoff",
};
```
