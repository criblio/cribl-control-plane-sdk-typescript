...
```typescript
import { KafkaSchemaRegistry1Type } from "cribl-control-plane/models";

let value: KafkaSchemaRegistry1Type = {
  auth: {
  ...
  defaultKeySchemaId: 354.73,
  defaultValueSchemaId: 7280.55,
};
```
...
| `auth`                                                                                                                            | [models.KafkaSchemaRegistry1TypeAuth](../models/kafkaschemaregistry1typeauth.md)                                                  | :heavy_minus_sign:                                                                                                                | Credentials to use when authenticating with the schema registry using basic HTTP authentication                                   |
| `tls`                                                                                                                             | [models.KafkaSchemaRegistry1TypeTLSSettingsClientSide](../models/kafkaschemaregistry1typetlssettingsclientside.md)                | :heavy_minus_sign:                                                                                                                | N/A                                                                                                                               |
