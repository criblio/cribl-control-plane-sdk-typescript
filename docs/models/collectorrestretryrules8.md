...
```typescript
import { CollectorRestRetryRules8 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules8 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.CollectorRestRetryType8](../models/collectorrestretrytype8.md) | :heavy_minus_sign:                                                     | Algorithm to use when performing HTTP retries                          |
