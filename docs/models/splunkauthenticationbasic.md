...
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `authentication`                                                                                                          | [models.SplunkAuthenticationBasicAuthentication](../models/splunkauthenticationbasicauthentication.md)                    | :heavy_minus_sign:                                                                                                        | Authentication method for Discover and Collect REST calls                                                                 |
...
| `outputMode`                                                                                                              | [models.SplunkAuthenticationBasicOutputMode](../models/splunkauthenticationbasicoutputmode.md)                            | :heavy_minus_sign:                                                                                                        | Format of the returned output                                                                                             |
...
| `retryRules`                                                                                                              | [models.SplunkAuthenticationBasicRetryRules](../models/splunkauthenticationbasicretryrules.md)                            | :heavy_minus_sign:                                                                                                        | N/A                                                                                                                       |