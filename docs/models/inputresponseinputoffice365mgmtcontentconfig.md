...
```typescript
import { InputResponseInputOffice365MgmtContentConfig } from "cribl-control-plane/models";

let value: InputResponseInputOffice365MgmtContentConfig = {};
```
...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `contentType`                                                                               | *string*                                                                                    | :heavy_minus_sign:                                                                          | Microsoft 365 Management Activity API Content Type                                          |
