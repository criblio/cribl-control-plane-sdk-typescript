...
```typescript
import { RestCollectMethodOtherRestDiscoveryDiscoverTypeList } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestDiscoveryDiscoverTypeList = {
  discoverType: "list",
  itemList: [
    "<value 1>",
    "<value 2>",
