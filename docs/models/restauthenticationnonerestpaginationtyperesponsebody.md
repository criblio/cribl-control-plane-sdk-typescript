...
```typescript
import { RestAuthenticationNoneRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [],
  maxPages: 3686.22,
};
...
| `attribute`                                                                                                                                                   | *models.RestAuthenticationNoneRestPaginationTypeResponseBodyResponseAttributes*                                                                               | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
