...
```typescript
import { RestCollectMethodPostWithBodyRetryRules } from "cribl-control-plane/models";

let value: RestCollectMethodPostWithBodyRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `type`                                                                                               | [models.RestCollectMethodPostWithBodyRetryType](../models/restcollectmethodpostwithbodyretrytype.md) | :heavy_minus_sign:                                                                                   | Algorithm to use when performing HTTP retries                                                        |
