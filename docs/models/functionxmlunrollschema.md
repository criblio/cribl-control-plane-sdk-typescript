...
```typescript
import { FunctionXmlUnrollSchema } from "cribl-control-plane/models";

let value: FunctionXmlUnrollSchema = {
  unroll: "<value>",
  inherit: "<value>",
};
```
...
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `unroll`                                                                                          | *string*                                                                                          | :heavy_minus_sign:                                                                                | Path to array to unroll. Example: ^root\.child\.ElementToUnroll$                                  |
