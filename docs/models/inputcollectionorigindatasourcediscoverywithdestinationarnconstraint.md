...
```typescript
import { InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint } from "cribl-control-plane/models";
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `origin`                                                                   | [models.Origin](../models/origin.md)                                       | :heavy_minus_sign:                                                         | Feature that created the Source.                                           |
