...
```typescript
import { RestAuthenticationBasicSecretRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationBasicSecretRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `type`                                                                                               | [models.RestAuthenticationBasicSecretRetryType](../models/restauthenticationbasicsecretretrytype.md) | :heavy_minus_sign:                                                                                   | Algorithm to use when performing HTTP retries                                                        |
