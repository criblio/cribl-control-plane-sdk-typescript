...
```typescript
import { RestCollectMethodOtherRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
