...
```typescript
import { Container3 } from "cribl-control-plane/models";
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `mode`                                                                                       | [models.ContainerMode3](../models/containermode3.md)                                         | :heavy_minus_sign:                                                                           | Select the level of detail for container metrics                                             |
...
| `filters`                                                                                    | [models.InputSystemMetricsFilter3](../models/inputsystemmetricsfilter3.md)[]                 | :heavy_minus_sign:                                                                           | Containers matching any of these will be included. All are included if no filters are added. |
