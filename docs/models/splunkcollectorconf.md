...
```typescript
import { SplunkCollectorConf } from "cribl-control-plane/models";

let value: SplunkCollectorConf = {
  search: "<value>",
  earliest: "<value>",
  latest: "<value>",
...
| `outputMode`                                                                                                              | [models.SplunkCollectorConfOutputMode](../models/splunkcollectorconfoutputmode.md)                                        | :heavy_minus_sign:                                                                                                        | Format of the returned output                                                                                             |
...
| `collectRequestHeaders`                                                                                                   | [models.SplunkCollectorConfCollectRequestHeader](../models/splunkcollectorconfcollectrequestheader.md)[]                  | :heavy_minus_sign:                                                                                                        | Optional collect request headers                                                                                          |
| `authentication`                                                                                                          | [models.SplunkCollectorConfAuthentication](../models/splunkcollectorconfauthentication.md)                                | :heavy_minus_sign:                                                                                                        | Authentication method for Discover and Collect REST calls                                                                 |
...
| `retryRules`                                                                                                              | [models.SplunkCollectorConfRetryRules](../models/splunkcollectorconfretryrules.md)                                        | :heavy_minus_sign:                                                                                                        | N/A                                                                                                                       |