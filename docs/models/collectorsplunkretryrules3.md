...
```typescript
import { CollectorSplunkRetryRules3 } from "cribl-control-plane/models";

let value: CollectorSplunkRetryRules3 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `type`                                                                     | [models.CollectorSplunkRetryType3](../models/collectorsplunkretrytype3.md) | :heavy_minus_sign:                                                         | Algorithm to use when performing HTTP retries                              |
