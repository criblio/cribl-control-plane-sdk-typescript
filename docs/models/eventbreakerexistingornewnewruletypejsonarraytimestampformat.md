...
```typescript
import { EventBreakerExistingOrNewNewRuleTypeJsonArrayTimestampFormat } from "cribl-control-plane/models";

let value: EventBreakerExistingOrNewNewRuleTypeJsonArrayTimestampFormat = {
  type: "auto",
};
```
