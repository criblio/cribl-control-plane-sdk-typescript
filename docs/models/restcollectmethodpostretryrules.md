...
```typescript
import { RestCollectMethodPostRetryRules } from "cribl-control-plane/models";

let value: RestCollectMethodPostRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [models.RestCollectMethodPostRetryType](../models/restcollectmethodpostretrytype.md) | :heavy_minus_sign:                                                                   | Algorithm to use when performing HTTP retries                                        |
