...
```typescript
import { RestAuthenticationNoneRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
