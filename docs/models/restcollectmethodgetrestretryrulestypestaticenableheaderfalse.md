...
```typescript
import { RestCollectMethodGetRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodGetRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
