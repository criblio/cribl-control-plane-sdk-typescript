...
```typescript
import { SNMPv3Authentication1 } from "cribl-control-plane/models";

let value: SNMPv3Authentication1 = {
  v3Users: [
    {
      name: "<value>",
      authKey: "<value>",
...
| `v3Users`                                                                                                            | [models.V3User1](../models/v3user1.md)[]                                                                             | :heavy_minus_sign:                                                                                                   | User credentials for receiving v3 traps                                                                              |