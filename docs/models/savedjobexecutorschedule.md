...
```typescript
import { SavedJobExecutorSchedule } from "cribl-control-plane/models";

let value: SavedJobExecutorSchedule = {
  enabled: true,
  run: {
    type: "collection",
    earliest: 475.38,
...
| `run`                                                                                                     | [models.SavedJobExecutorRunSettings](../models/savedjobexecutorrunsettings.md)                            | :heavy_minus_sign:                                                                                        | N/A                                                                                                       |