...
```typescript
import { RestAuthenticationOauthRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestAuthenticationOauthRestPaginationTypeRequestOffset = {
  type: "request_offset",
  offsetField: "<value>",
  offset: 8252.43,
  limitField: "<value>",
