...
```typescript
import { Target6 } from "cribl-control-plane/models";

let value: Target6 = {
  host: "worthless-mythology.info",
};
```
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `protocol`                                                  | [models.Protocol6](../models/protocol6.md)                  | :heavy_minus_sign:                                          | Protocol to use when collecting metrics                     |
