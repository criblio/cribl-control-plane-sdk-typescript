...
```typescript
import { OutputKafkaSchemaRegistryAuthenticationKafka } from "cribl-control-plane/models";

let value: OutputKafkaSchemaRegistryAuthenticationKafka = {
  auth: {
  ...
  defaultKeySchemaId: 324.77,
  defaultValueSchemaId: 7596.4,
};
```
...
| `auth`                                                                                                                            | [models.OutputAuthKafka](../models/outputauthkafka.md)                                                                            | :heavy_minus_sign:                                                                                                                | Credentials to use when authenticating with the schema registry using basic HTTP authentication                                   |
| `tls`                                                                                                                             | [models.OutputKafkaSchemaRegistryTLSSettingsClientSideKafka](../models/outputkafkaschemaregistrytlssettingsclientsidekafka.md)    | :heavy_minus_sign:                                                                                                                | N/A                                                                                                                               |
