...
```typescript
import { RestAuthenticationBasicRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
