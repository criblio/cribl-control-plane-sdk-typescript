...
```typescript
import { OutputResponseOutputLocalSearchStorageColumnMapping } from "cribl-control-plane/models";

let value: OutputResponseOutputLocalSearchStorageColumnMapping = {
  columnName: "<value>",
