...
```typescript
import { RestCollectMethodPostWithBodyRestDiscoveryDiscoverTypeList } from "cribl-control-plane/models";

let value: RestCollectMethodPostWithBodyRestDiscoveryDiscoverTypeList = {
  discoverType: "list",
  itemList: [
    "<value 1>",
    "<value 2>",
