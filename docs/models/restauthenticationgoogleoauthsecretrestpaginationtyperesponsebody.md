...
```typescript
import { RestAuthenticationGoogleOauthSecretRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationGoogleOauthSecretRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [
    "<value 1>",
    "<value 2>",
