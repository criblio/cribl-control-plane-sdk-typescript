...
```typescript
import { HealthCheckAuthenticationOauthSecretHealthCheckRetryRulesTypeNone } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationOauthSecretHealthCheckRetryRulesTypeNone = {
  type: "none",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
