...
```typescript
import { SplunkAuthenticationLoginSecretSplunkRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: SplunkAuthenticationLoginSecretSplunkRetryRulesTypeStatic = {
  type: "static",
  interval: "<value>",
  limit: "<value>",
  codes: "<value>",
