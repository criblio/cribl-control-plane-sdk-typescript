...
```typescript
import { SplunkAuthenticationBasicSplunkRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: SplunkAuthenticationBasicSplunkRetryRulesTypeBackoff = {
  type: "backoff",
};
```
