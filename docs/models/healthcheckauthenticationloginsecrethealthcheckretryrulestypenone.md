...
```typescript
import { HealthCheckAuthenticationLoginSecretHealthCheckRetryRulesTypeNone } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationLoginSecretHealthCheckRetryRulesTypeNone = {
  type: "none",
};
```
