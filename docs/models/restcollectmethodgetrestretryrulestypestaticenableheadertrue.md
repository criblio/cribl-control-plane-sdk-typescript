...
```typescript
import { RestCollectMethodGetRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestCollectMethodGetRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
