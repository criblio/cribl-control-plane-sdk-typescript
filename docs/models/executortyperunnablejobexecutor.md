...
| `conf`                                                                                                                                 | [models.ExecutorSpecificSettingsTypeRunnableJobExecutorExecutor](../models/executorspecificsettingstyperunnablejobexecutorexecutor.md) | :heavy_minus_sign:                                                                                                                     | Executor-specific settings                                                                                                             |