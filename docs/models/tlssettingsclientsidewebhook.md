...
```typescript
import { TLSSettingsClientSideWebhook } from "cribl-control-plane/models";
...
| `minVersion`                                                                                                      | [models.MinimumTLSVersionWebhook](../models/minimumtlsversionwebhook.md)                                          | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |
| `maxVersion`                                                                                                      | [models.MaximumTLSVersionWebhook](../models/maximumtlsversionwebhook.md)                                          | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |