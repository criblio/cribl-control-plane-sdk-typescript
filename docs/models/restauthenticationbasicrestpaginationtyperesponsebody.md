...
```typescript
import { RestAuthenticationBasicRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [
    "<value 1>",
    "<value 2>",
...
| `attribute`                                                                                                                                                   | *models.RestAuthenticationBasicRestPaginationTypeResponseBodyResponseAttributes*                                                                              | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
