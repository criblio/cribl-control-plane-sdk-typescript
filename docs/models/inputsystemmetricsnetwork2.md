...
```typescript
import { InputSystemMetricsNetwork2 } from "cribl-control-plane/models";

let value: InputSystemMetricsNetwork2 = {
  devices: [
    "<value 1>",
  ],
};
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `mode`                                                                                                         | [models.InputSystemMetricsNetworkMode2](../models/inputsystemmetricsnetworkmode2.md)                           | :heavy_minus_sign:                                                                                             | Select the level of detail for network metrics                                                                 |
