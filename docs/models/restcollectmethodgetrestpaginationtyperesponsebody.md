...
```typescript
import { RestCollectMethodGetRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestCollectMethodGetRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: "<value>",
  maxPages: 8083.82,
};
...
| `attribute`                                                                                                                                                   | *models.RestCollectMethodGetRestPaginationTypeResponseBodyResponseAttributes*                                                                                 | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
