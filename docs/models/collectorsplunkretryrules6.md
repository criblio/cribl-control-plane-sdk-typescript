...
```typescript
import { CollectorSplunkRetryRules6 } from "cribl-control-plane/models";

let value: CollectorSplunkRetryRules6 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `type`                                                                     | [models.CollectorSplunkRetryType6](../models/collectorsplunkretrytype6.md) | :heavy_minus_sign:                                                         | Algorithm to use when performing HTTP retries                              |
