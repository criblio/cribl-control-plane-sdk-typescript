...
```typescript
import { OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint5 } from "cribl-control-plane/models";

let value: OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint5 =
