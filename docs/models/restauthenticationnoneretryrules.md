...
```typescript
import { RestAuthenticationNoneRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `type`                                                                                 | [models.RestAuthenticationNoneRetryType](../models/restauthenticationnoneretrytype.md) | :heavy_minus_sign:                                                                     | Algorithm to use when performing HTTP retries                                          |
