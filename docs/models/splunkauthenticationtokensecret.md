...
```typescript
import { SplunkAuthenticationTokenSecret } from "cribl-control-plane/models";

let value: SplunkAuthenticationTokenSecret = {
  tokenSecret: "<value>",
  search: "<value>",
  earliest: "<value>",
  latest: "<value>",
...
| -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `authentication`                                                                                                                 | [models.SplunkAuthenticationTokenSecretAuthentication](../models/splunkauthenticationtokensecretauthentication.md)               | :heavy_minus_sign:                                                                                                               | Authentication method for Discover and Collect REST calls                                                                        |
| `tokenSecret`                                                                                                                    | *string*                                                                                                                         | :heavy_check_mark:                                                                                                               | Select or create a stored secret that references your Bearer token                                                               |
...
| `outputMode`                                                                                                                     | [models.SplunkAuthenticationTokenSecretOutputMode](../models/splunkauthenticationtokensecretoutputmode.md)                       | :heavy_minus_sign:                                                                                                               | Format of the returned output                                                                                                    |
| `collectRequestParams`                                                                                                           | [models.SplunkAuthenticationTokenSecretCollectRequestParam](../models/splunkauthenticationtokensecretcollectrequestparam.md)[]   | :heavy_minus_sign:                                                                                                               | Optional collect request parameters                                                                                              |
| `collectRequestHeaders`                                                                                                          | [models.SplunkAuthenticationTokenSecretCollectRequestHeader](../models/splunkauthenticationtokensecretcollectrequestheader.md)[] | :heavy_minus_sign:                                                                                                               | Optional collect request headers                                                                                                 |
