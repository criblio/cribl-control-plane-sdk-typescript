...
```typescript
import { OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint9 } from "cribl-control-plane/models";

let value: OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint9 =
