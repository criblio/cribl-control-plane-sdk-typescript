...
```typescript
import { CollectorSplunkRetryRules7 } from "cribl-control-plane/models";

let value: CollectorSplunkRetryRules7 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `type`                                                                     | [models.CollectorSplunkRetryType7](../models/collectorsplunkretrytype7.md) | :heavy_minus_sign:                                                         | Algorithm to use when performing HTTP retries                              |
