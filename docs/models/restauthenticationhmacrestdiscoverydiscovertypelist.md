...
```typescript
import { RestAuthenticationHmacRestDiscoveryDiscoverTypeList } from "cribl-control-plane/models";

let value: RestAuthenticationHmacRestDiscoveryDiscoverTypeList = {
  discoverType: "list",
  itemList: [
    "<value 1>",
  ],
