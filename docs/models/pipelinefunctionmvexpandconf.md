...
| `bagExpansionMode`                                                                                       | [models.PipelineFunctionMvExpandBagExpansionMode](../models/pipelinefunctionmvexpandbagexpansionmode.md) | :heavy_minus_sign:                                                                                       | decides if bag-values are expanded to bags or arrays                                                     |