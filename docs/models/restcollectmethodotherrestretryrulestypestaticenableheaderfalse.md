...
```typescript
import { RestCollectMethodOtherRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
