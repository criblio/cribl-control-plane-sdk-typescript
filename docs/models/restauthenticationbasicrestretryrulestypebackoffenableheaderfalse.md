...
```typescript
import { RestAuthenticationBasicRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
