...
```typescript
import { CollectorRestRetryRules12 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules12 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `type`                                                                   | [models.CollectorRestRetryType12](../models/collectorrestretrytype12.md) | :heavy_minus_sign:                                                       | Algorithm to use when performing HTTP retries                            |
