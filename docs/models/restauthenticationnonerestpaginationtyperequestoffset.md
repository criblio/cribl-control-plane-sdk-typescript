...
```typescript
import { RestAuthenticationNoneRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRestPaginationTypeRequestOffset = {
  type: "request_offset",
  offsetField: "<value>",
  offset: 9495.4,
  limitField: "<value>",
