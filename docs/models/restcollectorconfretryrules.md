...
```typescript
import { RestCollectorConfRetryRules } from "cribl-control-plane/models";

let value: RestCollectorConfRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `type`                                                                       | [models.RestCollectorConfRetryType](../models/restcollectorconfretrytype.md) | :heavy_minus_sign:                                                           | Algorithm to use when performing HTTP retries                                |
