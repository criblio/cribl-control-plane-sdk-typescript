...
| `fieldConditions`                                                                                  | [models.FunctionConfSchemaJoinFieldCondition](../models/functionconfschemajoinfieldcondition.md)[] | :heavy_minus_sign:                                                                                 | Fields to use when joining                                                                         |
