...
```typescript
import { HealthCheckAuthenticationOauthSecretHealthCheckRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationOauthSecretHealthCheckRetryRulesTypeStatic =
  {
    type: "static",
  };
```
