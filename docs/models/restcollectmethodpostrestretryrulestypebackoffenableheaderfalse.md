...
```typescript
import { RestCollectMethodPostRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodPostRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
