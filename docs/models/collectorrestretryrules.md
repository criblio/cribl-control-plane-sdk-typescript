...
```typescript
import { CollectorRestRetryRules } from "cribl-control-plane/models";

let value: CollectorRestRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `type`                                                               | [models.CollectorRestRetryType](../models/collectorrestretrytype.md) | :heavy_minus_sign:                                                   | Algorithm to use when performing HTTP retries                        |
