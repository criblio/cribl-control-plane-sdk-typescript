...
```typescript
import { HealthCheckAuthenticationLoginSecretDiscoverType } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationLoginSecretDiscoverType = "none";
```
