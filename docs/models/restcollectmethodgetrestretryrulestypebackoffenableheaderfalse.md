...
```typescript
import { RestCollectMethodGetRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodGetRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
