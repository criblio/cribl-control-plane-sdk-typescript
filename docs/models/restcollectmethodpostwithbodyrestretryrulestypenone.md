...
```typescript
import { RestCollectMethodPostWithBodyRestRetryRulesTypeNone } from "cribl-control-plane/models";

let value: RestCollectMethodPostWithBodyRestRetryRulesTypeNone = {
  type: "none",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
