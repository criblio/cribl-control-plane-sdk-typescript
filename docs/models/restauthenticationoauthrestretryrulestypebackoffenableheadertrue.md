...
```typescript
import { RestAuthenticationOauthRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationOauthRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
