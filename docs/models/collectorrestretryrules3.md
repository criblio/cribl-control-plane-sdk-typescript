...
```typescript
import { CollectorRestRetryRules3 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules3 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.CollectorRestRetryType3](../models/collectorrestretrytype3.md) | :heavy_minus_sign:                                                     | Algorithm to use when performing HTTP retries                          |
