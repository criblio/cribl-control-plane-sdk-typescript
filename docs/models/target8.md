...
```typescript
import { Target8 } from "cribl-control-plane/models";

let value: Target8 = {
  host: "caring-palate.net",
};
```
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `protocol`                                                  | [models.Protocol8](../models/protocol8.md)                  | :heavy_minus_sign:                                          | Protocol to use when collecting metrics                     |
