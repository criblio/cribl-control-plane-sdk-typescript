...
```typescript
import { InputResponseProjects } from "cribl-control-plane/models";

let value: InputResponseProjects = {};
```
...
| `manageState`                                                                                        | [models.ProjectsManageStateAnthropicCompliance](../models/projectsmanagestateanthropiccompliance.md) | :heavy_minus_sign:                                                                                   | N/A                                                                                                  |