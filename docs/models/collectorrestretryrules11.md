...
```typescript
import { CollectorRestRetryRules11 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules11 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `type`                                                                   | [models.CollectorRestRetryType11](../models/collectorrestretrytype11.md) | :heavy_minus_sign:                                                       | Algorithm to use when performing HTTP retries                            |
