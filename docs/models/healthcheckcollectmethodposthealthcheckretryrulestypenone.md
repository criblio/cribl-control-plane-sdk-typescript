...
```typescript
import { HealthCheckCollectMethodPostHealthCheckRetryRulesTypeNone } from "cribl-control-plane/models";

let value: HealthCheckCollectMethodPostHealthCheckRetryRulesTypeNone = {
  type: "none",
};
```
