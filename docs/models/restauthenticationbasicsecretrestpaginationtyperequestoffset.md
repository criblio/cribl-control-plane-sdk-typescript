...
```typescript
import { RestAuthenticationBasicSecretRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestAuthenticationBasicSecretRestPaginationTypeRequestOffset = {
  type: "request_offset",
  offsetField: "<value>",
  offset: 9351.5,
  limitField: "<value>",
