...
```typescript
import { SplunkAuthenticationLoginSplunkRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: SplunkAuthenticationLoginSplunkRetryRulesTypeStatic = {
  type: "static",
  interval: "<value>",
  limit: "<value>",
  codes: "<value>",
