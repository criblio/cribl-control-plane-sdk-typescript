...
```typescript
import { RestCollectMethodOtherRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestCollectMethodOtherRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
