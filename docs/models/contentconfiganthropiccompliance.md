...
```typescript
import { ContentConfigAnthropicCompliance } from "cribl-control-plane/models";

let value: ContentConfigAnthropicCompliance = {
  contentType: "groups",
  cronSchedule: "<value>",
};
```
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `contentType`                                                                                | [models.InputResponseEndpointName](../models/inputresponseendpointname.md)                   | :heavy_check_mark:                                                                           | N/A                                                                                          |
...
| `manageState`                                                                                | [models.ManageStateAnthropicCompliance](../models/managestateanthropiccompliance.md)         | :heavy_minus_sign:                                                                           | N/A                                                                                          |
