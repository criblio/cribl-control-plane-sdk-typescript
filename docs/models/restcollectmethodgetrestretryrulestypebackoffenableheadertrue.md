...
```typescript
import { RestCollectMethodGetRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestCollectMethodGetRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
