...
| `maxDepth`                                                                                                                         | *number*                                                                                                                           | :heavy_minus_sign:                                                                                                                 | Maximum recursion depth when traversing nested objects. Prevents infinite loops caused by cyclic references. Defaults to 20.       |