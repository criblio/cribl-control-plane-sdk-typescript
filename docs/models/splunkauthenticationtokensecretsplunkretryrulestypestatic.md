...
```typescript
import { SplunkAuthenticationTokenSecretSplunkRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: SplunkAuthenticationTokenSecretSplunkRetryRulesTypeStatic = {
  type: "static",
  interval: "<value>",
  limit: "<value>",
  codes: "<value>",
