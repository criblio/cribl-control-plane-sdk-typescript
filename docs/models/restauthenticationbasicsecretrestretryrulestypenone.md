...
```typescript
import { RestAuthenticationBasicSecretRestRetryRulesTypeNone } from "cribl-control-plane/models";

let value: RestAuthenticationBasicSecretRestRetryRulesTypeNone = {
  type: "none",
};
```
