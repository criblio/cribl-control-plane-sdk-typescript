...
```typescript
import { CpuWindowsMetrics } from "cribl-control-plane/models";
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ |
| `mode`                                                             | [models.CpuModeWindowsMetrics](../models/cpumodewindowsmetrics.md) | :heavy_minus_sign:                                                 | Select the level of details for CPU metrics                        |
