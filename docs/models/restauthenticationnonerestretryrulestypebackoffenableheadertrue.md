...
```typescript
import { RestAuthenticationNoneRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
