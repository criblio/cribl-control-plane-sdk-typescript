...
```typescript
import { CollectorRestRetryRules2 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules2 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.CollectorRestRetryType2](../models/collectorrestretrytype2.md) | :heavy_minus_sign:                                                     | Algorithm to use when performing HTTP retries                          |
