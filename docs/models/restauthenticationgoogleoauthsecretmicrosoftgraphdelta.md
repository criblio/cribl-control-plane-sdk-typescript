...
```typescript
import { RestAuthenticationGoogleOauthSecretMicrosoftGraphDelta } from "cribl-control-plane/models";

let value: RestAuthenticationGoogleOauthSecretMicrosoftGraphDelta = {};
```
