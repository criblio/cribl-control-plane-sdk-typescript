...
```typescript
import { RestAuthenticationBasicSecretRestDiscoveryDiscoverTypeList } from "cribl-control-plane/models";

let value: RestAuthenticationBasicSecretRestDiscoveryDiscoverTypeList = {
  discoverType: "list",
  itemList: [
    "<value 1>",
    "<value 2>",
