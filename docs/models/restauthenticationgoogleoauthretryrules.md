...
```typescript
import { RestAuthenticationGoogleOauthRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationGoogleOauthRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `type`                                                                                               | [models.RestAuthenticationGoogleOauthRetryType](../models/restauthenticationgoogleoauthretrytype.md) | :heavy_minus_sign:                                                                                   | Algorithm to use when performing HTTP retries                                                        |
