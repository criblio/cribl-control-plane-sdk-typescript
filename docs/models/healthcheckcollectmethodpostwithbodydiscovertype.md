...
```typescript
import { HealthCheckCollectMethodPostWithBodyDiscoverType } from "cribl-control-plane/models";

let value: HealthCheckCollectMethodPostWithBodyDiscoverType = "list";
```
