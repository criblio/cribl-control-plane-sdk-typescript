...
```typescript
import { InputWindowsMetricsNetwork3 } from "cribl-control-plane/models";

let value: InputWindowsMetricsNetwork3 = {
  devices: [
    "<value 1>",
    "<value 2>",
    "<value 3>",
...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `mode`                                                                                    | [models.InputWindowsMetricsNetworkMode3](../models/inputwindowsmetricsnetworkmode3.md)    | :heavy_minus_sign:                                                                        | Select the level of details for network metrics                                           |
