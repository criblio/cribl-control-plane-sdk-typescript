...
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `authentication`                                                                                                          | [models.SplunkAuthenticationTokenAuthentication](../models/splunkauthenticationtokenauthentication.md)                    | :heavy_minus_sign:                                                                                                        | Authentication method for Discover and Collect REST calls                                                                 |
...
| `outputMode`                                                                                                              | [models.SplunkAuthenticationTokenOutputMode](../models/splunkauthenticationtokenoutputmode.md)                            | :heavy_minus_sign:                                                                                                        | Format of the returned output                                                                                             |
| `collectRequestParams`                                                                                                    | [models.SplunkAuthenticationTokenCollectRequestParam](../models/splunkauthenticationtokencollectrequestparam.md)[]        | :heavy_minus_sign:                                                                                                        | Optional collect request parameters                                                                                       |
| `collectRequestHeaders`                                                                                                   | [models.SplunkAuthenticationTokenCollectRequestHeader](../models/splunkauthenticationtokencollectrequestheader.md)[]      | :heavy_minus_sign:                                                                                                        | Optional collect request headers                                                                                          |
...
| `retryRules`                                                                                                              | [models.SplunkAuthenticationTokenRetryRules](../models/splunkauthenticationtokenretryrules.md)                            | :heavy_minus_sign:                                                                                                        | N/A                                                                                                                       |