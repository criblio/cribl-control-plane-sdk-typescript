...
```typescript
import { RestAuthenticationHmacRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationHmacRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
