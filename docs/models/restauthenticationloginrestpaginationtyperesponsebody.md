...
```typescript
import { RestAuthenticationLoginRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationLoginRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: "<value>",
  maxPages: 5573.43,
};
...
| `attribute`                                                                                                                                                   | *models.RestAuthenticationLoginRestPaginationTypeResponseBodyResponseAttributes*                                                                              | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
