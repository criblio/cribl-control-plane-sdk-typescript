...
```typescript
import { HealthCheckAuthenticationBasicHealthCheckRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationBasicHealthCheckRetryRulesTypeBackoff = {
  type: "backoff",
};
```
