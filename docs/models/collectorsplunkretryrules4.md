...
```typescript
import { CollectorSplunkRetryRules4 } from "cribl-control-plane/models";

let value: CollectorSplunkRetryRules4 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `type`                                                                     | [models.CollectorSplunkRetryType4](../models/collectorsplunkretrytype4.md) | :heavy_minus_sign:                                                         | Algorithm to use when performing HTTP retries                              |
