...
```typescript
import { RestAuthenticationLoginSecretRestRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: RestAuthenticationLoginSecretRestRetryRulesTypeStatic = {
  type: "static",
};
```
