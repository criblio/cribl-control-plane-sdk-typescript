...
```typescript
import { FunctionSerializeConf } from "cribl-control-plane/models";

let value: FunctionSerializeConf = {
  delimChar: "<value>",
  quoteChar: "<value>",
  escapeChar: "<value>",
  nullValue: "<value>",
...
| ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                                             | [models.FunctionSerializeType](../models/functionserializetype.md)                                                                 | :heavy_minus_sign:                                                                                                                 | Data output format                                                                                                                 |
