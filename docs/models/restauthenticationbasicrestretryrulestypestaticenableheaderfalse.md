...
```typescript
import { RestAuthenticationBasicRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
