...
```typescript
import { RestAuthenticationNoneRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationNoneRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
