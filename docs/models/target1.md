...
```typescript
import { Target1 } from "cribl-control-plane/models";

let value: Target1 = {
  host: "faint-palate.biz",
};
```
...
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| `protocol`                                                  | [models.Protocol1](../models/protocol1.md)                  | :heavy_minus_sign:                                          | Protocol to use when collecting metrics                     |
