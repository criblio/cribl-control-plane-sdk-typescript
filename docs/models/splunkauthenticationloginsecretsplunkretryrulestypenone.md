...
```typescript
import { SplunkAuthenticationLoginSecretSplunkRetryRulesTypeNone } from "cribl-control-plane/models";

let value: SplunkAuthenticationLoginSecretSplunkRetryRulesTypeNone = {
  type: "none",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
