...
```typescript
import { RestAuthenticationOauthRestRetryRulesTypeStaticEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestAuthenticationOauthRestRetryRulesTypeStaticEnableHeaderTrue = {
  type: "<value>",
};
```
