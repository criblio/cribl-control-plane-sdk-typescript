...
```typescript
import { HealthCheckAuthenticationOauthHealthCheckRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationOauthHealthCheckRetryRulesTypeBackoff = {
  type: "backoff",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
