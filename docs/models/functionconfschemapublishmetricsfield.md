...
| `metricType`                                                                                                 | [models.FunctionConfSchemaPublishMetricsMetricType](../models/functionconfschemapublishmetricsmetrictype.md) | :heavy_check_mark:                                                                                           | The type of metric to publish (counter, timer, gauge, distribution, summary, or histogram).                  |