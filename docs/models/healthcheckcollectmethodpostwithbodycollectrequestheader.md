...
```typescript
import { HealthCheckCollectMethodPostWithBodyCollectRequestHeader } from "cribl-control-plane/models";

let value: HealthCheckCollectMethodPostWithBodyCollectRequestHeader = {
  name: "<value>",
  value: "<value>",
};
```
