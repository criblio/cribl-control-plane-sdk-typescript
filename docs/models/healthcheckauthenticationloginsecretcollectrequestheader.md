...
```typescript
import { HealthCheckAuthenticationLoginSecretCollectRequestHeader } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationLoginSecretCollectRequestHeader = {
  name: "<value>",
  value: "<value>",
};
```
