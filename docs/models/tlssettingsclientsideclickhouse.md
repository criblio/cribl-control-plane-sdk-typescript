...
```typescript
import { TLSSettingsClientSideClickHouse } from "cribl-control-plane/models";
...
| `minVersion`                                                                                                      | [models.MinimumTLSVersionClickHouse](../models/minimumtlsversionclickhouse.md)                                    | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |
| `maxVersion`                                                                                                      | [models.MaximumTLSVersionClickHouse](../models/maximumtlsversionclickhouse.md)                                    | :heavy_minus_sign:                                                                                                | N/A                                                                                                               |