...
```typescript
import { OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint4 } from "cribl-control-plane/models";

let value: OutputAzureDataExplorerMicrosoftEntraIDAuthenticationEndpoint4 =
