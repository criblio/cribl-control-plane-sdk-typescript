...
```typescript
import { CollectorRestRetryRules5 } from "cribl-control-plane/models";

let value: CollectorRestRetryRules5 = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.CollectorRestRetryType5](../models/collectorrestretrytype5.md) | :heavy_minus_sign:                                                     | Algorithm to use when performing HTTP retries                          |
