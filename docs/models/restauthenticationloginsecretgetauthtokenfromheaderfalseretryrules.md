...
```typescript
import { RestAuthenticationLoginSecretGetAuthTokenFromHeaderFalseRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationLoginSecretGetAuthTokenFromHeaderFalseRetryRules =
  {
    type: "none",
    interval: "<value>",
    limit: "<value>",
