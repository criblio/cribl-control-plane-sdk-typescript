...
```typescript
import { RestAuthenticationLoginSecretRestPaginationTypeResponseBody } from "cribl-control-plane/models";

let value: RestAuthenticationLoginSecretRestPaginationTypeResponseBody = {
  type: "response_body",
  attribute: [
    "<value 1>",
    "<value 2>",
...
| `attribute`                                                                                                                                                   | *models.RestAuthenticationLoginSecretRestPaginationTypeResponseBodyResponseAttributes*                                                                        | :heavy_check_mark:                                                                                                                                            | Names of attributes within the response that contain next-page information                                                                                    |
