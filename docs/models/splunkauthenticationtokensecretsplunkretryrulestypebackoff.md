...
```typescript
import { SplunkAuthenticationTokenSecretSplunkRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: SplunkAuthenticationTokenSecretSplunkRetryRulesTypeBackoff = {
  type: "backoff",
};
```
