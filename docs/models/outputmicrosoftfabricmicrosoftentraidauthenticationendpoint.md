...
```typescript
import { OutputMicrosoftFabricMicrosoftEntraIDAuthenticationEndpoint } from "cribl-control-plane/models";

let value: OutputMicrosoftFabricMicrosoftEntraIDAuthenticationEndpoint =
