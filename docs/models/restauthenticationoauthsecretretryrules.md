...
```typescript
import { RestAuthenticationOauthSecretRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationOauthSecretRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `type`                                                                                               | [models.RestAuthenticationOauthSecretRetryType](../models/restauthenticationoauthsecretretrytype.md) | :heavy_minus_sign:                                                                                   | Algorithm to use when performing HTTP retries                                                        |
