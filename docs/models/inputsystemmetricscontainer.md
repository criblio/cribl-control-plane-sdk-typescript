...
```typescript
import { InputSystemMetricsContainer } from "cribl-control-plane/models";

let value: InputSystemMetricsContainer = {};
```
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `mode`                                                                                       | [models.InputSystemMetricsContainerMode](../models/inputsystemmetricscontainermode.md)       | :heavy_minus_sign:                                                                           | Select the level of detail for container metrics                                             |
