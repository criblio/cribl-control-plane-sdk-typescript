...
```typescript
import { SplunkCollectorConfRetryRules } from "cribl-control-plane/models";

let value: SplunkCollectorConfRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `type`                                                                           | [models.SplunkCollectorConfRetryType](../models/splunkcollectorconfretrytype.md) | :heavy_minus_sign:                                                               | Algorithm to use when performing HTTP retries                                    |
