...
```typescript
import { RestCollectMethodPostRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestCollectMethodPostRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
