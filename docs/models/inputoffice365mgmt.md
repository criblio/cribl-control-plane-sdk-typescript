...
### `models.InputOffice365MgmtPqEnabledTrueWithPqConstraint`

```typescript
const value: models.InputOffice365MgmtPqEnabledTrueWithPqConstraint = {
  pqEnabled: false,
  pq: {
    mode: "smart",
    maxBufferSize: 1717.96,
  ...
  authType: "secret",
  description: "but duh worriedly ferret",
  clientSecret: "<value>",
  textSecret: "<value>",
};
```
