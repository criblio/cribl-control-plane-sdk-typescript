...
```typescript
import { SNMPv3Authentication2 } from "cribl-control-plane/models";

let value: SNMPv3Authentication2 = {
  v3Users: [
    {
      name: "<value>",
      authKey: "<value>",
...
| `v3Users`                                                                                                            | [models.V3User2](../models/v3user2.md)[]                                                                             | :heavy_minus_sign:                                                                                                   | User credentials for receiving v3 traps                                                                              |