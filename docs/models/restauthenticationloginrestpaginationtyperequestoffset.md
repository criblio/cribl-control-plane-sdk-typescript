...
```typescript
import { RestAuthenticationLoginRestPaginationTypeRequestOffset } from "cribl-control-plane/models";

let value: RestAuthenticationLoginRestPaginationTypeRequestOffset = {
  type: "request_offset",
  offsetField: "<value>",
  offset: 7797.93,
  limitField: "<value>",
