...
```typescript
import { RestAuthenticationOauthRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationOauthRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
