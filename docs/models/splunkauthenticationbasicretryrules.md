...
```typescript
import { SplunkAuthenticationBasicRetryRules } from "cribl-control-plane/models";

let value: SplunkAuthenticationBasicRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  codes: "<value>",
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `type`                                                                                       | [models.SplunkAuthenticationBasicRetryType](../models/splunkauthenticationbasicretrytype.md) | :heavy_minus_sign:                                                                           | Algorithm to use when performing HTTP retries                                                |
