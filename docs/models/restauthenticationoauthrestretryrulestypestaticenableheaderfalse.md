...
```typescript
import { RestAuthenticationOauthRestRetryRulesTypeStaticEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationOauthRestRetryRulesTypeStaticEnableHeaderFalse = {
  type: "<value>",
};
```
