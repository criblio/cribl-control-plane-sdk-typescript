...
```typescript
import { HealthCheckAuthenticationLoginHealthCheckRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: HealthCheckAuthenticationLoginHealthCheckRetryRulesTypeStatic = {
  type: "static",
};
```
