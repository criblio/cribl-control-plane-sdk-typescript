...
```typescript
import { RestCollectMethodPostRestRetryRulesTypeBackoffEnableHeaderTrue } from "cribl-control-plane/models";

let value: RestCollectMethodPostRestRetryRulesTypeBackoffEnableHeaderTrue = {
  type: "<value>",
};
```
