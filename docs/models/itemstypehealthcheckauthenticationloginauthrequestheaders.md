...
```typescript
import { ItemsTypeHealthCheckAuthenticationLoginAuthRequestHeaders } from "cribl-control-plane/models";

let value: ItemsTypeHealthCheckAuthenticationLoginAuthRequestHeaders = {
  name: "<value>",
  value: "<value>",
};
```
