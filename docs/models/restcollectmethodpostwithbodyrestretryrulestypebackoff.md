...
```typescript
import { RestCollectMethodPostWithBodyRestRetryRulesTypeBackoff } from "cribl-control-plane/models";

let value: RestCollectMethodPostWithBodyRestRetryRulesTypeBackoff = {
  type: "backoff",
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
