...
```typescript
import { RestAuthenticationBasicRetryRules } from "cribl-control-plane/models";

let value: RestAuthenticationBasicRetryRules = {
  interval: "<value>",
  limit: "<value>",
  multiplier: "<value>",
  maxIntervalMs: "<value>",
...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `type`                                                                                   | [models.RestAuthenticationBasicRetryType](../models/restauthenticationbasicretrytype.md) | :heavy_minus_sign:                                                                       | Algorithm to use when performing HTTP retries                                            |
