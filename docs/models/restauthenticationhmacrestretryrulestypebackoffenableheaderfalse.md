...
```typescript
import { RestAuthenticationHmacRestRetryRulesTypeBackoffEnableHeaderFalse } from "cribl-control-plane/models";

let value: RestAuthenticationHmacRestRetryRulesTypeBackoffEnableHeaderFalse = {
  type: "<value>",
};
```
