...
```typescript
import { RestAuthenticationOauthSecretRestRetryRulesTypeStatic } from "cribl-control-plane/models";

let value: RestAuthenticationOauthSecretRestRetryRulesTypeStatic = {
  type: "static",
  interval: "<value>",
  limit: "<value>",
  codes: "<value>",
