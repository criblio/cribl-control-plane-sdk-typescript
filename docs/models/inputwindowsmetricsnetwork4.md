...
```typescript
import { InputWindowsMetricsNetwork4 } from "cribl-control-plane/models";

let value: InputWindowsMetricsNetwork4 = {
  devices: [
    "<value 1>",
    "<value 2>",
  ],
...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `mode`                                                                                    | [models.InputWindowsMetricsNetworkMode4](../models/inputwindowsmetricsnetworkmode4.md)    | :heavy_minus_sign:                                                                        | Select the level of details for network metrics                                           |
