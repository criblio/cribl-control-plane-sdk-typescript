...
import { teamsGetProductsGroupsAclTeamsByProductAndId } from "cribl-control-plane/funcs/teamsGetProductsGroupsAclTeamsByProductAndId.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("teamsGetProductsGroupsAclTeamsByProductAndId failed:", res.error);
  }
}
