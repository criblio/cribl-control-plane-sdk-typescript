...
import { groupsAclTeamsGet } from "cribl-control-plane/funcs/groupsAclTeamsGet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("groupsAclTeamsGet failed:", res.error);
  }
}
...
**Promise\<[models.CountedListTeamAccessControlList](../../models/countedlistteamaccesscontrollist.md)\>**
