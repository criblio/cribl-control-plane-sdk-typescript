...
<!-- UsageSnippet language="typescript" operationID="createSystemSettingsRestart" method="post" path="/system/settings/restart" example="RestartSystemExamplesDefault" -->
```typescript
