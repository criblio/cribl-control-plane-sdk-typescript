...
<!-- UsageSnippet language="typescript" operationID="createSystemSettingsRestart" method="post" path="/system/settings/restart" -->
```typescript
...
import { systemSettingsRestart } from "cribl-control-plane/funcs/systemSettingsRestart.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("systemSettingsRestart failed:", res.error);
  }
}
...
**Promise\<[models.CountedSystemRestartResponse](../../models/countedsystemrestartresponse.md)\>**
