...
async function run() {
  const result = await criblControlPlane.destinations.update({
    ...
    output: {
      ...
      maxFileSizeMB: 4562.74,
      maxFileOpenTimeSec: 2532.09,
      maxFileIdleTimeSec: 1271.28,
      maxOpenFiles: 3246.22,
      headerLine: "<value>",
      writeHighWaterMark: 3612.5,
      onBackpressure: "block",
      ...
      emptyDirCleanupSec: 1965.22,
      directoryBatchSize: 3079.24,
