...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { lakeGetCriblLakeDatasetByLakeId } from "cribl-control-plane/funcs/lakeGetCriblLakeDatasetByLakeId.js";
...
async function run() {
  const res = await lakeGetCriblLakeDatasetByLakeId(criblControlPlane, {
    lakeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("lakeGetCriblLakeDatasetByLakeId failed:", res.error);
  }
}
...
async function run() {
  const result = await criblControlPlane.lake.deleteCriblLakeDatasetByLakeIdAndId({
    lakeId: "<id>",
    id: "<id>",
  });
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { lakeDeleteCriblLakeDatasetByLakeIdAndId } from "cribl-control-plane/funcs/lakeDeleteCriblLakeDatasetByLakeIdAndId.js";
...
async function run() {
  const res = await lakeDeleteCriblLakeDatasetByLakeIdAndId(criblControlPlane, {
    lakeId: "<id>",
    id: "<id>",
  });
  if (res.ok) {
    ...
    console.log("lakeDeleteCriblLakeDatasetByLakeIdAndId failed:", res.error);
  }
}
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { lakeGetCriblLakeDatasetByLakeIdAndId } from "cribl-control-plane/funcs/lakeGetCriblLakeDatasetByLakeIdAndId.js";
...
async function run() {
  const res = await lakeGetCriblLakeDatasetByLakeIdAndId(criblControlPlane, {
    lakeId: "<id>",
    id: "<id>",
  });
  if (res.ok) {
    ...
    console.log("lakeGetCriblLakeDatasetByLakeIdAndId failed:", res.error);
  }
}
...
async function run() {
  const result = await criblControlPlane.lake.updateCriblLakeDatasetByLakeIdAndId({
    lakeId: "<id>",
    id: "<id>",
    criblLakeDataset: {
      acceleratedFields: [
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { lakeUpdateCriblLakeDatasetByLakeIdAndId } from "cribl-control-plane/funcs/lakeUpdateCriblLakeDatasetByLakeIdAndId.js";
...
async function run() {
  const res = await lakeUpdateCriblLakeDatasetByLakeIdAndId(criblControlPlane, {
    lakeId: "<id>",
    id: "<id>",
    criblLakeDataset: {
      acceleratedFields: [
  ...
  if (res.ok) {
    ...
    console.log("lakeUpdateCriblLakeDatasetByLakeIdAndId failed:", res.error);
  }
}
