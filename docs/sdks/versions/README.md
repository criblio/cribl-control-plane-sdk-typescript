...
async function run() {
  const result = await criblControlPlane.versions.getConfigStatus();
...
import { versionsGetConfigStatus } from "cribl-control-plane/funcs/versionsGetConfigStatus.js";
...
async function run() {
  const res = await versionsGetConfigStatus(criblControlPlane);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("versionsGetConfigStatus failed:", res.error);
  }
}
...
async function run() {
  const result = await criblControlPlane.versions.getCurrentStatus({
    group: "<value>",
  });
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { versionsGetCurrentStatus } from "cribl-control-plane/funcs/versionsGetCurrentStatus.js";
...
async function run() {
  const res = await versionsGetCurrentStatus(criblControlPlane, {
    group: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("versionsGetCurrentStatus failed:", res.error);
  }
}
...
async function run() {
  const result = await criblControlPlane.versions.syncLocalRemote();
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { versionsSyncLocalRemote } from "cribl-control-plane/funcs/versionsSyncLocalRemote.js";
...
async function run() {
  const res = await versionsSyncLocalRemote(criblControlPlane);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("versionsSyncLocalRemote failed:", res.error);
  }
}
