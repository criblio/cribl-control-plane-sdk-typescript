...
import { versionsCommitsFilesCount } from "cribl-control-plane/funcs/versionsCommitsFilesCount.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("versionsCommitsFilesCount failed:", res.error);
  }
}
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { versionsCommitsFilesList } from "cribl-control-plane/funcs/versionsCommitsFilesList.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("versionsCommitsFilesList failed:", res.error);
  }
}
