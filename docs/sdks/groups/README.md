...
* [createByProduct](#createbyproduct) - Create a Fleet or Worker Group
* [getByProduct](#getbyproduct) - Get a list of ConfigGroup objects
* [delete](#delete) - Delete a Fleet or Worker Group
* [get](#get) - Get a specific ConfigGroup object
* [update](#update) - Update a Fleet or Worker Group
* [deployCommits](#deploycommits) - Deploy commits for a Fleet or Worker Group
* [getTeamAccessControlListByProduct](#getteamaccesscontrollistbyproduct) - ACL of team with permissions for resources in this Group
* [getAccessControlList](#getaccesscontrollist) - ACL of members with permissions for resources in this Group
