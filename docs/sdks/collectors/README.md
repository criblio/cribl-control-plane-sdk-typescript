...
<!-- UsageSnippet language="typescript" operationID="createSavedJob" method="post" path="/lib/jobs" example="authenticationFailed" -->
```typescript
import { CriblControlPlane } from "cribl-control-plane";
...
<!-- UsageSnippet language="typescript" operationID="updateSavedJobById" method="patch" path="/lib/jobs/{id}" example="authenticationFailed" -->
```typescript
import { CriblControlPlane } from "cribl-control-plane";
