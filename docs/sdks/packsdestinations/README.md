...
<!-- UsageSnippet language="typescript" operationID="updateOutputSystemByPackAndId" method="patch" path="/p/{pack}/system/outputs/{id}" example="OutputCreateExamplesCustomerMetricsStorage" -->
```typescript
import { CriblControlPlane } from "cribl-control-plane";
