...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { workersGetWorkers } from "cribl-control-plane/funcs/workersGetWorkers.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("workersGetWorkers failed:", res.error);
  }
}
...
**Promise\<[operations.GetWorkersResponse](../../models/operations/getworkersresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="updateWorkersRestart" method="patch" path="/master/workers/restart" -->
```typescript
import { CriblControlPlane } from "cribl-control-plane";
...
```typescript
import { CriblControlPlaneCore } from "cribl-control-plane/core.js";
import { workersUpdateWorkersRestart } from "cribl-control-plane/funcs/workersUpdateWorkersRestart.js";
...
async function run() {
  const res = await workersUpdateWorkersRestart(criblControlPlane);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("workersUpdateWorkersRestart failed:", res.error);
  }
}
...
**Promise\<[operations.UpdateWorkersRestartResponse](../../models/operations/updateworkersrestartresponse.md)\>**
