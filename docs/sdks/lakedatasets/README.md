...
* [create](#create) - Create a Dataset in the specified Lake
* [list](#list) - Get the list of Dataset contained in the specified Lake
* [delete](#delete) - Delete a Dataset in the specified Lake
* [get](#get) - Get a Dataset in the specified Lake
* [update](#update) - Update a Dataset in the specified Lake
